...
Rancher v2.10.11 is the latest patch release of Rancher v2.10. This is a Prime version release that introduces maintenance updates and bug fixes. To learn more about Rancher Prime, see our page on the [Rancher Prime Platform](https://www.rancher.com/products/rancher-platform).
...
See the full list of [changes](https://github.com/rancher/rancher/compare/v2.10.10%E2%80%A6v2.10.11).
...
- CLI - [v2.10.11](https://github.com/rancher/cli/releases/tag/v2.10.11)

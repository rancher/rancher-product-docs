...
Rancher v2.13.6 is the latest patch release of Rancher. This is a Community version release that introduces maintenance updates and bug fixes.
...
- Fixed an issue where add-on charts' values were not preserved when viewing or editing clusters in the Rancher UI. Using the **Edit Config** option could reset chart values to defaults. Editing cluster configurations using **Edit as YAML** directly or `kubectl` is not affected. See [\#17526](https://github.com/rancher/dashboard/issues/17526).

- Fixed an issue where there was no option to install a new instance of a chart that was already installed. It is now possible to install the same chart multiple times in the same cluster. See [\#16926](https://github.com/rancher/dashboard/issues/16926).

## Changes Since v2.13.5

See the full list of [changes](https://github.com/rancher/rancher/compare/v2.13.5%E2%80%A6v2.13.6).
...
- rancher/rancher:v2.13.6

### Tools

- CLI - [v2.13.6](https://github.com/rancher/cli/releases/tag/v2.13.6)

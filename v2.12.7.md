...
Rancher v2.12.7 is the latest patch release of Rancher v2.12. This is a Prime version release that introduces maintenance updates and bug fixes. To learn more about Rancher Prime, see our page on the [Rancher Prime Platform](https://www.rancher.com/products/rancher-platform).
...
## Changes Since v2.12.6

See the full list of [changes](https://github.com/rancher/rancher/compare/v2.12.6%E2%80%A6v2.12.7).
...
- rancher/rancher:v2.12.7

### Tools

- CLI - [v2.12.7](https://github.com/rancher/cli/releases/tag/v2.12.7)

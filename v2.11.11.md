...
Rancher v2.11.11 is the latest patch release of Rancher v2.11. This is a Prime version release that introduces maintenance updates and bug fixes. To learn more about Rancher Prime, see our page on the [Rancher Prime Platform](https://www.rancher.com/products/rancher-platform).
...
See the full list of [changes](https://github.com/rancher/rancher/compare/v2.11.10%E2%80%A6v2.11.11).
...
- rancher/rancher:v2.11.11

### Tools

- CLI - [v2.11.11](https://github.com/rancher/cli/releases/tag/v2.11.11)

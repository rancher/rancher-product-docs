...
Rancher v2.12.8 is the latest patch release of Rancher v2.12. This is a Prime version release that introduces maintenance updates and bug fixes. To learn more about Rancher Prime, see our page on the [Rancher Prime Platform](https://www.rancher.com/products/rancher-platform).
...
- Fixed an issue where the [SUSE Customer Center (SCC)](https://scc.suse.com/home) system view had a known issue regarding duplicate Rancher Manager registrations. See [rancher/scc-operator \#38](https://github.com/rancher/scc-operator/issues/38).
...
- After updating an RKE2 or K3s cluster to a supported Kubernetes version, the S3 snapshot retention defaults to `5`, ignoring any previously set `snapshotRetention` values. This is caused by a known issue in RKE2 and K3s, tracked in [\#13769](https://github.com/k3s-io/k3s/issues/13769), which is targeted for a fix in a future KDM update. See [\#52710](https://github.com/rancher/rancher/issues/52710).

## Changes Since v2.12.7

See the full list of [changes](https://github.com/rancher/rancher/compare/v2.12.7%E2%80%A6v2.12.8).
...
- rancher/rancher:v2.12.8

### Tools

- CLI - [v2.12.8](https://github.com/rancher/cli/releases/tag/v2.12.8)

...
Rancher v2.11.18 is the latest patch release of Rancher v2.11. This is a Prime version release that introduces maintenance updates and bug fixes. To learn more about Rancher Prime, see our page on the [Rancher Prime Platform](https://www.rancher.com/products/rancher-platform).
...
## Changes Since v2.11.17

See the full list of [changes](https://github.com/rancher/rancher/compare/v2.11.17%E2%80%A6v2.11.18).
...
- rancher/rancher:v2.11.18

### Tools

- CLI - [v2.11.18](https://github.com/rancher/cli/releases/tag/v2.11.18)
...
- **Rancher v2.7.2:**
  ...
  - When viewing or editing the YAML configuration of downstream RKE2 clusters through the UI, `spec.rkeConfig.machineGlobalConfig.profile` is set to `null`, which is an invalid configuration. See [\#8480](https://github.com/rancher/dashboard/issues/8480).
    ...
    - [RKE2 uninstall script](https://documentation.suse.com/cloudnative/rke2/latest/en/install/uninstall.html#_tarball_method_1).

...
:rn-fleet-gitrepo-custom-ca-bundle: https://fleet.rancher.io/how-tos-for-users/gitrepo-add#_using_custom_ca_bundles
:rn-rke2-uninstall-tarball: https://docs.rke2.io/install/uninstall?_highlight=uninstall#tarball-method
endif::[]
ifeval::["{build-type}" != "community"]
:rn-private-registry: https://documentation.suse.com/cloudnative/k3s/latest/en/installation/private-registry.html
:rn-fleet-gitrepo-custom-ca-bundle: https://documentation.suse.com/cloudnative/continuous-delivery/latest/en/how-tos-for-users/gitrepo-add.html#_using_custom_ca_bundles
:rn-rke2-uninstall-tarball: https://documentation.suse.com/cloudnative/rke2/latest/en/install/uninstall.html#_tarball_method_1
endif::[]
...
** Fleet now honors custom certificate authority (CA) bundles https://documentation.suse.com/en-us/cloudnative/rancher-manager/v2.11/en/installation-and-upgrade/references/helm-chart-options.html#_additional_trusted_cas[configured] in Rancher.
  ...
  See the {rn-fleet-gitrepo-custom-ca-bundle}[Fleet documentation] and https://github.com/rancher/fleet/issues/2750[fleet#2750].
...
*** {rn-rke2-uninstall-tarball}[RKE2 uninstall script].

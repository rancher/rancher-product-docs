...
Rancher v2.13.7 is the latest patch release of Rancher. This is a Community version release that introduces maintenance updates and bug fixes.
...
## Changes Since v2.13.6

See the full list of [changes](https://github.com/rancher/rancher/compare/v2.13.6%E2%80%A6v2.13.7).
...
- rancher/rancher:v2.13.7

### Tools

- CLI - [v2.13.7](https://github.com/rancher/cli/releases/tag/v2.13.7)

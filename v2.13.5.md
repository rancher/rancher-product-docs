...
Rancher v2.13.5 is the latest patch release of Rancher. This is a Community version release that introduces maintenance updates and bug fixes.
...
## Changes Since v2.13.4

See the full list of [changes](https://github.com/rancher/rancher/compare/v2.13.4%E2%80%A6v2.13.5).
...
- rancher/rancher:v2.13.5

### Tools

- CLI - [v2.13.5](https://github.com/rancher/cli/releases/tag/v2.13.5)

...
:community-path: reference-guides/rancher-security/hardening-guides/rke2-hardening-guide/index.adoc 
:product-path: security/hardening-guides/rke2/rke2.adoc

...
When Rancher installs Kubernetes, it uses {xref-launch-k8s-with-rancher}[RKE] or https://documentation.suse.com/cloudnative/rke2/latest/en/introduction.html[RKE2] as the Kubernetes distribution.

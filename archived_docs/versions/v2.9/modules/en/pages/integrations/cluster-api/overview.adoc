...
:url-capi-values: https://documentation.suse.com/cloudnative/cluster-api/{turtles-docs-version}/en/reference-guides/rancher-turtles-chart/values.html 
:url-capi-using-helm: https://documentation.suse.com/cloudnative/cluster-api/{turtles-docs-version}/en/getting-started/install-rancher-turtles/using_helm.html 
endif::[]
ifeval::["{build-type}" == "community"]
:url-capi-slsa: https://turtles.docs.rancher.com/turtles/{turtles-docs-version}/en/security/slsa.html 
:url-capi-values: https://turtles.docs.rancher.com/turtles/{turtles-docs-version}/en/reference-guides/rancher-turtles-chart/values.html
:url-capi-using-helm: https://turtles.docs.rancher.com/turtles/{turtles-docs-version}/en/getting-started/install-rancher-turtles/using_helm.html
endif::[]
...
The CAPI Operator allows for handling the lifecycle of {url-capi-using-helm}[CAPI providers] using a declarative approach, extending the capabilities of `clusterctl`. If you want to learn more about it, you can refer to https://cluster-api-operator.sigs.k8s.io/[Cluster API Operator book].
...
For detailed information on the values supported by the chart and their usage, refer to {url-capi-values}[Helm chart options].
====
...
Remember that if you opt for this installation option, you must manage the CAPI Operator installation yourself. You can follow the {url-capi-using-helm}[manual installation guide] in the Cluster API documentation for assistance.
====

...
:xref-opa-gatekeeper: xref:integrations/opa-gatekeeper.adoc
endif::[]
ifeval::["{build-type}" == "community"]
...
:xref-opa-gatekeeper: xref:integrations-in-rancher/opa-gatekeeper.adoc
endif::[]
...
For more information, refer to the logging documentation {xref-logging}[here.]
...
For more information, refer to the monitoring documentation {xref-monitoring-and-dashboards}[here.]
...
For more information, refer to the Istio documentation {xref-istio}[here.]

== OPA Gatekeeper

include::shared:ROOT:partial$en/deprecation-opa-gatekeeper.adoc[]

https://github.com/open-policy-agent/gatekeeper[OPA Gatekeeper] is an open-source project that provides integration between OPA and Kubernetes to provide policy control via admission controller webhooks. For details on how to enable Gatekeeper in Rancher, refer to the {xref-opa-gatekeeper}[OPA Gatekeeper section.]

== CIS Scans

Rancher can run a security scan to check whether Kubernetes is deployed according to security best practices as defined in the CIS Kubernetes Benchmark.

For more information, refer to the CIS scan documentation {xref-cis-howto}[here.]

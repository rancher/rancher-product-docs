...
Rancher v2.13.10 is the latest patch release of Rancher. This is a Prime version release that introduces maintenance updates and bug fixes. To learn more about Rancher Prime, see our page on the [Rancher Prime Platform](https://www.rancher.com/products/rancher-platform).
...
- The GKE provisioning UI now excludes Kubernetes versions that are not supported by any GKE release channel, reducing provisioning failures caused by selecting invalid versions. See [\#18930](https://github.com/rancher/dashboard/issues/18930).

## Changes Since v2.13.9

See the full list of [changes](https://github.com/rancher/rancher/compare/v2.13.9%E2%80%A6v2.13.10).
...
- rancher/rancher:v2.13.10

### Tools

- CLI - [v2.13.10](https://github.com/rancher/cli/releases/tag/v2.13.10)
...
- **Rancher v2.13.10:**
  ...
  - Google Cloud now requires new GKE clusters to use a release channel. Rancher v2.13.10 filters out Kubernetes versions that are not supported by any GKE release channel in the provisioning UI, but the broader GKE release channel support work remains in progress. GCP’s automatic out-of-band upgrades can still cause state drift in Rancher, which may block cluster edits, break node pool updates, or cause provisioning failures. See [\#56879](https://github.com/rancher/rancher/issues/56879).

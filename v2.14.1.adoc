...
:rn-fleet-enable-imagescan: https://fleet.rancher.io/how-tos-for-operators/installation#enabling-imagescan
...
:rn-fleet-enable-imagescan: https://documentation.suse.com/cloudnative/continuous-delivery/latest/en/how-tos-for-operators/installation.html#_enabling_imagescan

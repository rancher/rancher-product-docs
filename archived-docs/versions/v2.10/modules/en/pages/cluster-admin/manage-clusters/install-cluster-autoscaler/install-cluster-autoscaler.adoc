...
:community-path: how-to-guides/new-user-guides/manage-clusters/install-cluster-autoscaler/index.adoc 
:product-path: cluster-admin/manage-clusters/install-cluster-autoscaler/install-cluster-autoscaler.adoc

...
:community-path: reference-guides/cluster-configuration/rancher-server-configuration/use-existing-nodes/rancher-agent-options.adoc 
:product-path: cluster-deployment/custom-clusters/rancher-agent-options.adoc

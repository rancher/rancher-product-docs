...
:community-path: how-to-guides/new-user-guides/launch-kubernetes-with-rancher/rke1-vs-rke2-differences.adoc 
:product-path: cluster-deployment/rke1-vs-rke2.adoc

...
| CIS v1.9
| https://documentation.suse.com/cloudnative/rke2/latest/zh/security/cis_self_assessment9.html[链接]
...
| CIS v1.8
| https://documentation.suse.com/cloudnative/k3s/latest/zh/security/self-assessment-1.9.html[链接]

...
For additional details, see the Security Advisories and CVEs page in Rancher’s [documentation](https://ranchermanager.docs.rancher.com/v2.13/reference-guides/rancher-security/security-advisories-and-cves) or in Rancher’s GitHub [repository](https://github.com/rancher/rancher/security/advisories).

## Rancher App (Global UI)

### Major Bug Fixes

- Fixed an issue where the selection of pods in the Rancher UI (**Workloads \> Pods**) would reset when the status of a pod changed. See [\#16094](https://github.com/rancher/dashboard/issues/16094).

- Added additional improvements to reduce the amount of failed network requests when fetching resources shown in lists in the Rancher UI by reducing the length of the URL used in the request. This failure was more likely to happen when viewing resources in the local cluster as an administrator. See [\#16216](https://github.com/rancher/dashboard/issues/16216).

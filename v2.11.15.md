...
Rancher v2.11.15 is the latest patch release of Rancher v2.11. This is a Prime version release that introduces maintenance updates and bug fixes. To learn more about Rancher Prime, see our page on the [Rancher Prime Platform](https://www.rancher.com/products/rancher-platform).
...
See the full list of [changes](https://github.com/rancher/rancher/compare/v2.11.14%E2%80%A6v2.11.15).
...
- rancher/rancher:v2.11.15

### Tools

- CLI - [v2.11.15](https://github.com/rancher/cli/releases/tag/v2.11.15)

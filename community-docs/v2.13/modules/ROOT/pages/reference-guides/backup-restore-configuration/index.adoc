...
:community-path: reference-guides/backup-restore-configuration/backup-restore-configuration
:product-path:
...
For example Backup custom resources, refer to xref:reference-guides/backup-restore-configuration/examples.adoc#_backup[this page.]

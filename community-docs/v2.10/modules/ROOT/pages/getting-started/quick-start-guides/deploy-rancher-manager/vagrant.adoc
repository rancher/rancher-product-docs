...
:community-path: getting-started/quick-start-guides/deploy-rancher-manager/vagrant
:product-path:
...
* https://developer.hashicorp.com/vagrant[Vagrant]: Vagrant is required as this is used to provision the machine based on the Vagrantfile.

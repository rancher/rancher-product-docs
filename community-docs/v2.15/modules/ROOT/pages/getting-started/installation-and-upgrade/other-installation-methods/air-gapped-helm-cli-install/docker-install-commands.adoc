...
:community-path: getting-started/installation-and-upgrade/other-installation-methods/air-gapped-helm-cli-install/docker-install-commands 
:product-path:
...
.Do you want to..
====
* Configure custom CA root certificate to access your services? See xref:getting-started/installation-and-upgrade/resources/custom-ca-root-certificates.adoc[Custom CA root certificate].
...
| `<RANCHER_VERSION_TAG>`
| The release tag of the xref:getting-started/installation-and-upgrade/installation-references/helm-chart-options.adoc[Rancher version] that you want to install.
|===

Privileged access is xref:getting-started/installation-and-upgrade/other-installation-methods/air-gapped-helm-cli-install/install-rancher-ha.adoc#_privileged_access_for_rancher[required.]

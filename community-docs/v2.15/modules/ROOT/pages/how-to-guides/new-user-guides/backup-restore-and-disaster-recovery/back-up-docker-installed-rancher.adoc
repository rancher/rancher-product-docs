...
:community-path: how-to-guides/new-user-guides/backup-restore-and-disaster-recovery/back-up-docker-installed-rancher
:product-path:
...
**Result:** A backup tarball of your Rancher Server data is created. See xref:how-to-guides/new-user-guides/backup-restore-and-disaster-recovery/restore-docker-installed-rancher.adoc[Restoring Backups: Docker Installs] if you need to restore backup data.

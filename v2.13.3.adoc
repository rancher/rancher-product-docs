...
- Fixed a bug where the Cluster Autoscaler failed to install on downstream clusters due to incorrect Helm chart and image registry paths. See https://github.com/rancher/rancher/issues/53915[#53915].
endif::[]

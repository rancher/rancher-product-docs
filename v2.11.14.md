...
Rancher v2.11.14 is the latest patch release of Rancher v2.11. This is a Prime version release that introduces maintenance updates and bug fixes. To learn more about Rancher Prime, see our page on the [Rancher Prime Platform](https://www.rancher.com/products/rancher-platform).
...
## Changes Since v2.11.13

See the full list of [changes](https://github.com/rancher/rancher/compare/v2.11.13%E2%80%A6v2.11.14).
...
- rancher/rancher:v2.11.14

### Tools

- CLI - [v2.11.14](https://github.com/rancher/cli/releases/tag/v2.11.14)

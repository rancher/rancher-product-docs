...
:community-path: how-to-guides/advanced-user-guides/cis-scan-guides/uninstall-rancher-cis-benchmark 
:product-path: security/cis-scans/uninstall-rancher-cis-benchmark
:experimental:

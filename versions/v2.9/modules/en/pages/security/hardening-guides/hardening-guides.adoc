...
:xref-k3s-self-assessment-17: xref:security/hardening-guides/k3s/self-assessment-guide-with-cis-v1.7-k8s-v1.25-v1.26-v1.27.adoc
:xref-k3s-self-assessment-124: xref:security/hardening-guides/k3s/self-assessment-guide-with-cis-v1.24-k8s-v1.24.adoc
endif::[]
ifeval::["{build-type}" == "community"]
...
:xref-k3s-self-assessment-17: xref:reference-guides/rancher-security/hardening-guides/k3s-hardening-guide/k3s-self-assessment-guide-with-cis-v1.7-k8s-v1.25-v1.26-v1.27.adoc
:xref-k3s-self-assessment-124: xref:security/hardening-guides/k3s/self-assessment-guide-with-cis-v1.24-k8s-v1.24.adoc
endif::[]
...
| Kubernetes v1.25/v1.26/v1.27
| CIS v1.7
| {xref-k3s-self-assessment-17}[Link]
| {xref-k3s-hardening-guide}[Link]

...
:community-path: integrations-in-rancher/monitoring-and-alerting/how-monitoring-works 
:product-path: observability/monitoring-and-dashboards/how-monitoring-works

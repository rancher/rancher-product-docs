...
As a prerequisite, you must create a {xref-secrets}[secret] or xref:cluster-admin/kubernetes-resources/configmaps.adoc[configmap] to be the source of the audit policy.
...
Rancher Dashboard provides an easy-to-use form for creating the {xref-secrets}[secret] or xref:cluster-admin/kubernetes-resources/configmaps.adoc[configmap].
====

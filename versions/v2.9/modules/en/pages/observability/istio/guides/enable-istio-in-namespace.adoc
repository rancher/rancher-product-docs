...
:community-path: how-to-guides/advanced-user-guides/istio-setup-guide/enable-istio-in-namespace 
:product-path: observability/istio/guides/enable-istio-in-namespace
:experimental:

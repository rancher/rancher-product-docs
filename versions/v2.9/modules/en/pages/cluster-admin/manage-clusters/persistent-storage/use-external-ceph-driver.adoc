...
:community-path: how-to-guides/new-user-guides/manage-clusters/create-kubernetes-persistent-storage/manage-persistent-storage/use-external-ceph-driver 
:product-path: cluster-admin/manage-clusters/persistent-storage/use-external-ceph-driver
:experimental:

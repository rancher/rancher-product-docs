...
:community-path: how-to-guides/new-user-guides/authentication-permissions-and-global-configuration/global-default-private-registry 
:product-path: rancher-admin/global-configuration/global-default-private-registry

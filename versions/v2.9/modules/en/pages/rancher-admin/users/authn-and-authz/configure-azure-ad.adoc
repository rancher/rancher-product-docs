...
:community-path: how-to-guides/new-user-guides/authentication-permissions-and-global-configuration/authentication-config/configure-azure-ad 
:product-path: rancher-admin/users/authn-and-authz/configure-azure-ad

...
:community-path: reference-guides/backup-restore-configuration/backup-configuration 
:product-path: rancher-admin/back-up-restore-and-disaster-recovery/configuration/backup

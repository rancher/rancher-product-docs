...
This example shows that the AWS credential secret does not have to be provided to create a backup if the nodes running `rancher-backup` have link:backup.adoc#iam-permissions-for-ec2-nodes-to-access-s3[these permissions for access to S3.]
...
This example shows that the AWS credential secret does not have to be provided to restore from backup if the nodes running `rancher-backup` have link:backup.adoc#iam-permissions-for-ec2-nodes-to-access-s3[these permissions for access to S3.]

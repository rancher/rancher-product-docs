...
:community-path: integrations-in-rancher/cloud-marketplace/aws-cloud-marketplace/install-adapter 
:product-path: installation-and-upgrade/hosted-kubernetes/cloud-marketplace/aws/install-adapter

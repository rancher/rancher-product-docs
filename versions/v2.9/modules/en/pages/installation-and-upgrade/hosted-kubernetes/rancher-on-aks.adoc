...
:community-path: getting-started/installation-and-upgrade/install-upgrade-on-a-kubernetes-cluster/rancher-on-aks 
:product-path: installation-and-upgrade/hosted-kubernetes/rancher-on-aks

...
:community-path: getting-started/installation-and-upgrade/installation-requirements/install-docker.adoc 
:product-path: installation-and-upgrade/requirements/install-docker.adoc

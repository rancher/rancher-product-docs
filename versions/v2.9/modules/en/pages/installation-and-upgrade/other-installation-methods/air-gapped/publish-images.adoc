...
:community-path: getting-started/installation-and-upgrade/other-installation-methods/air-gapped-helm-cli-install/publish-images 
:product-path: installation-and-upgrade/other-installation-methods/air-gapped/publish-images

...
For a longer discussion of Rancher architecture, refer to the xref:about-rancher/architecture/architecture.adoc[architecture overview,] {xref-arch-rec}[recommendations for production-grade architecture,] or our xref:installation-and-upgrade/best-practices/tips-for-running-rancher.adoc[best practices guide.]

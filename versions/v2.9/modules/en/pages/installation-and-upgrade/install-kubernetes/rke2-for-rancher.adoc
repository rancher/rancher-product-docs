...
:community-path: how-to-guides/new-user-guides/kubernetes-cluster-setup/rke2-for-rancher 
:product-path: installation-and-upgrade/install-kubernetes/rke2-for-rancher

...
:community-path: how-to-guides/new-user-guides/kubernetes-cluster-setup/rke1-for-rancher 
:product-path: installation-and-upgrade/install-kubernetes/rke1-for-rancher

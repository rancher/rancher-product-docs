...
:community-path: getting-started/quick-start-guides/deploy-workloads/nodeports 
:product-path: installation-and-upgrade/quick-start/deploy-workloads/nodeports

...
:community-path: how-to-guides/new-user-guides/kubernetes-cluster-setup/high-availability-installs 
:product-path: installation-and-upgrade/best-practices/high-availability-installs

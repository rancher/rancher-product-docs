...
:community-path: reference-guides/best-practices/rancher-server/tuning-and-best-practices-for-rancher-at-scale 
:product-path: installation-and-upgrade/best-practices/tuning-rancher-at-scale

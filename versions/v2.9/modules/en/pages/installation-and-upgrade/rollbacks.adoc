...
:xref-rancher-restore: xref:rancher-admin/back-up-restore-and-disaster-recovery/configuration/restore.adoc
...
:xref-rancher-restore: xref:reference-guides/backup-restore-configuration/restore-configuration.adoc
...
. Click *Create*.
. Create the Restore with the form or with YAML. For help creating the Restore resource using the online form, refer to the {xref-rancher-restore}[configuration reference] and to the {xref-back-restore-example-configs}[examples.]
...
----
+
For help configuring the Restore, refer to the {xref-rancher-restore}[configuration reference] and to the {xref-back-restore-example-configs}[examples.]

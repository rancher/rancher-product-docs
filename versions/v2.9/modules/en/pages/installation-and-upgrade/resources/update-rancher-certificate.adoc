...
:community-path: getting-started/installation-and-upgrade/resources/update-rancher-certificate 
:product-path: installation-and-upgrade/resources/update-rancher-certificate

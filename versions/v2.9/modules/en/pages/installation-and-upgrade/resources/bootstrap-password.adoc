...
:community-path: getting-started/installation-and-upgrade/resources/bootstrap-password 
:product-path: installation-and-upgrade/resources/bootstrap-password

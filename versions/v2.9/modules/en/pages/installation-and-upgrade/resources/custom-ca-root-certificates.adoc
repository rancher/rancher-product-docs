...
:community-path: getting-started/installation-and-upgrade/resources/custom-ca-root-certificates 
:product-path: installation-and-upgrade/resources/custom-ca-root-certificates

...
For detailed information on the values supported by the chart and their usage, refer to link:https://documentation.suse.com/cloudnative/cluster-api/v0.18/en/operator/chart.html[Helm chart options].
====

...
* Configure the https://documentation.suse.com/cloudnative/cluster-api/v0.15/en/reference-guides/rancher-turtles-chart/values.html#_cluster_api_operator_values[CAPI Operator].

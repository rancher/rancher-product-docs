...
Provision the host according to the {xref-node-reqs}[installation requirements] and the xref:cluster-deployment/production-checklist/production-checklist.adoc[checklist for production-ready clusters.]
 ...
 ** See {xref-use-windows-clusters}[Enable the Windows Support Option].

...
When Rancher installs Kubernetes, it uses xref:cluster-deployment/launch-kubernetes-with-rancher.adoc[RKE] or https://docs.rke2.io/[RKE2] as the Kubernetes distribution.

...
:community-path: reference-guides/cluster-configuration/rancher-server-configuration/rke1-cluster-configuration.adoc 
:product-path: cluster-deployment/configuration/rke1.adoc

...
:community-path: how-to-guides/new-user-guides/kubernetes-clusters-in-rancher-setup/checklist-for-production-ready-clusters/roles-for-nodes-in-kubernetes 
:product-path: cluster-deployment/production-checklist/roles-for-nodes-in-kubernetes

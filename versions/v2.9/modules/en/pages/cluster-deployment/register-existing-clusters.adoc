...
:xref-about-rancher-agents: xref:cluster-deployment/about-rancher-agents.adocendif::[]
ifeval::["{build-type}" == "community"]
...
* The ability to {xref-ds-backup-restore}[upgrade the Kubernetes version]

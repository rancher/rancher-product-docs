...
:community-path: how-to-guides/new-user-guides/kubernetes-clusters-in-rancher-setup/set-up-cloud-providers/configure-in-tree-vsphere 
:product-path: cluster-deployment/set-up-cloud-providers/configure-in-tree-vsphere

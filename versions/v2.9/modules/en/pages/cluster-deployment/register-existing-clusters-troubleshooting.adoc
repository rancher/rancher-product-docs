...
:community-path: troubleshooting/other-troubleshooting-tips/registered-clusters 
:product-path: cluster-deployment/register-existing-clusters-troubleshooting

...
:community-path: reference-guides/cluster-configuration/downstream-cluster-configuration/node-template-configuration/digitalocean 
:product-path: cluster-deployment/infra-providers/digitalocean/node-template-configuration

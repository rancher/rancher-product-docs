...
:community-path: reference-guides/cluster-configuration/downstream-cluster-configuration/machine-configuration/amazon-ec2 
:product-path: cluster-deployment/infra-providers/aws/machine-configuration

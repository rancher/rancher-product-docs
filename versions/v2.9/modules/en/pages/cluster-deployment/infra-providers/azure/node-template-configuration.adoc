...
:community-path: reference-guides/cluster-configuration/downstream-cluster-configuration/node-template-configuration/azure 
:product-path: cluster-deployment/infra-providers/azure/node-template-configuration

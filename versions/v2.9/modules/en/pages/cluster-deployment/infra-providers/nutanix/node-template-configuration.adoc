...
:community-path: reference-guides/cluster-configuration/downstream-cluster-configuration/node-template-configuration/nutanix 
:product-path: cluster-deployment/infra-providers/nutanix/node-template-configuration

...
:page-community-path: integrations-in-rancher/kubernetes-distributions/index.adoc 
:page-product-path: integrations/kubernetes-distributions.adoc
...
* Standard Rancher management of Kubernetes clusters including all outlined {xref-cluster-deployment}#_cluster_management_capabilities_by_cluster_type[cluster management capabilities].

...
:page-community-path: how-to-guides/advanced-user-guides/compliance-scan-guides/view-reports.adoc 
:page-product-path: security/compliance-scans/view-reports.adoc
:experimental:

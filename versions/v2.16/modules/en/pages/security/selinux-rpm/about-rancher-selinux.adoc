...
:page-community-path: reference-guides/rancher-security/selinux-rpm/about-rancher-selinux.adoc 
:page-product-path: security/selinux-rpm/about-rancher-selinux.adoc
...
[#_configuring_applications_to_work_with_selinux]

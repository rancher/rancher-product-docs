...
:page-community-path: integrations-in-rancher/logging/logging-helm-chart-options.adoc 
:page-product-path: observability/logging/logging-helm-chart-options.adoc

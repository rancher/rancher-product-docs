...
:page-community-path: how-to-guides/advanced-user-guides/enable-api-audit-log-in-downstream-clusters.adoc 
:page-product-path: observability/logging/enable-api-audit-log-in-downstream-clusters.adoc

...
:page-community-path: integrations-in-rancher/istio/configuration-options/project-network-isolation.adoc 
:page-product-path: observability/istio/configuration/project-network-isolation.adoc

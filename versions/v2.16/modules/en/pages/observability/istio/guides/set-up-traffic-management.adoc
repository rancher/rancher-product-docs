...
:page-community-path: how-to-guides/advanced-user-guides/istio-setup-guide/set-up-traffic-management.adoc 
:page-product-path: observability/istio/guides/set-up-traffic-management.adoc

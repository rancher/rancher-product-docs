...
:page-community-path: how-to-guides/advanced-user-guides/istio-setup-guide/use-istio-sidecar.adoc 
:page-product-path: observability/istio/guides/use-istio-sidecar.adoc

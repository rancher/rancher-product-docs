...
:page-community-path: reference-guides/monitoring-v2-configuration/receivers.adoc 
:page-product-path: observability/monitoring-and-dashboards/configuration/receivers.adoc
:experimental:

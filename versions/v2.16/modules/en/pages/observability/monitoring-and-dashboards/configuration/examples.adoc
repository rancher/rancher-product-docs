...
:page-community-path: reference-guides/monitoring-v2-configuration/examples.adoc 
:page-product-path: observability/monitoring-and-dashboards/configuration/examples.adoc

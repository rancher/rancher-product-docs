...
:page-community-path: integrations-in-rancher/monitoring-and-alerting/windows-support.adoc 
:page-product-path: observability/monitoring-and-dashboards/windows-support.adoc

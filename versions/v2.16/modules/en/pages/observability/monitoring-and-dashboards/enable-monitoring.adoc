...
:page-community-path: how-to-guides/advanced-user-guides/monitoring-alerting-guides/enable-monitoring.adoc 
:page-product-path: observability/monitoring-and-dashboards/enable-monitoring.adoc
:experimental:

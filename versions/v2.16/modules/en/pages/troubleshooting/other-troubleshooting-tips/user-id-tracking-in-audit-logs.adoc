...
:page-community-path: troubleshooting/other-troubleshooting-tips/user-id-tracking-in-audit-logs.adoc 
:page-product-path: troubleshooting/other-troubleshooting-tips/user-id-tracking-in-audit-logs.adoc

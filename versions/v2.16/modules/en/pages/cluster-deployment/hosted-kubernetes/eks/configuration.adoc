...
:page-community-path: reference-guides/cluster-configuration/rancher-server-configuration/eks-cluster-configuration.adoc 
:page-product-path: cluster-deployment/hosted-kubernetes/eks/configuration.adoc

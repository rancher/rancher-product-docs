...
:page-community-path: how-to-guides/new-user-guides/kubernetes-clusters-in-rancher-setup/set-up-clusters-from-hosted-kubernetes-providers/gke.adoc 
:page-product-path: cluster-deployment/hosted-kubernetes/gke/gke.adoc

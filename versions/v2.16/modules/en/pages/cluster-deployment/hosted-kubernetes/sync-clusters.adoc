...
:page-community-path: reference-guides/cluster-configuration/rancher-server-configuration/sync-clusters.adoc 
:page-product-path: cluster-deployment/hosted-kubernetes/sync-clusters.adoc

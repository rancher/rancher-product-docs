...
:page-community-path: reference-guides/best-practices/rancher-managed-clusters/rancher-managed-clusters-in-vsphere.adoc 
:page-product-path: cluster-deployment/infra-providers/vsphere/best-practices.adoc

...
:page-community-path: how-to-guides/new-user-guides/kubernetes-clusters-in-rancher-setup/checklist-for-production-ready-clusters/recommended-cluster-architecture.adoc 
:page-product-path: cluster-deployment/production-checklist/recommended-cluster-architecture.adoc

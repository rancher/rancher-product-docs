...
:page-community-path: how-to-guides/new-user-guides/helm-charts-in-rancher/oci-repositories.adoc 
:page-product-path: cluster-admin/helm-charts-in-rancher/oci-repositories.adoc

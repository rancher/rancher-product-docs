...
:page-community-path: how-to-guides/new-user-guides/manage-clusters/manage-cluster-templates.adoc 
:page-product-path: cluster-admin/manage-clusters/cluster-templates.adoc
:experimental:
ifeval::["{build-type}" != "community"]
:url-continuous-delivery-gitrepo-content: https://documentation.suse.com/cloudnative/continuous-delivery/{fleet-docs-version}/en/explanations/gitrepo-content.html
endif::[]
ifeval::["{build-type}" == "community"]
:url-continuous-delivery-gitrepo-content: https://fleet.rancher.io/{fleet-docs-version}/explanations/gitrepo-content
endif::[]
...
* Fleet repositories must follow these {url-continuous-delivery-gitrepo-content}[guidelines]. For RKE2 cluster templates, that means a `fleet.yaml` file must be added to the repository.
====

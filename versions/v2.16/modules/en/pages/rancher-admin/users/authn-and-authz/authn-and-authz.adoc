...
:page-community-path: how-to-guides/new-user-guides/authentication-permissions-and-global-configuration/authentication-config/index.adoc 
:page-product-path: rancher-admin/users/authn-and-authz/authn-and-authz.adoc
:weight: 10
...
:xref-configure-entra-id: xref:rancher-admin/users/authn-and-authz/configure-azure-ad.adoc
...
:xref-configure-entra-id: xref:how-to-guides/new-user-guides/authentication-permissions-and-global-configuration/authentication-config/configure-azure-ad.adoc
...
| {xref-configure-entra-id}[Microsoft Entra ID]
...
For example, to add a safeguard to the Microsoft Entra ID provider, annotate the `azuread` authconfig object:

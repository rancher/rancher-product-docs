...
:page-community-path: how-to-guides/new-user-guides/authentication-permissions-and-global-configuration/jwt-authentication.adoc 
:page-product-path: rancher-admin/users/authn-and-authz/jwt-authentication.adoc

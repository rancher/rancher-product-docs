...
:page-community-path: how-to-guides/new-user-guides/authentication-permissions-and-global-configuration/global-default-private-registry.adoc 
:page-product-path: rancher-admin/global-configuration/global-default-private-registry.adoc
...
. If you create the secret outside the Rancher UI, ensure that <<_working_with_private_registry_credentials,backup labels are set>>
. Select *☰ > Global Settings*.

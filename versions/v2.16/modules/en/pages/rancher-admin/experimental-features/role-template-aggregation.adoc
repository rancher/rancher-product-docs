...
:page-community-path: how-to-guides/advanced-user-guides/enable-experimental-features/role-template-aggregation.adoc 
:page-product-path: rancher-admin/experimental-features/role-template-aggregation.adoc

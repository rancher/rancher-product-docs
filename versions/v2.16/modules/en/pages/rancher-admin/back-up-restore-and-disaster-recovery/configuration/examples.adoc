...
:page-community-path: reference-guides/backup-restore-configuration/examples.adoc 
:page-product-path: rancher-admin/back-up-restore-and-disaster-recovery/configuration/examples.adoc

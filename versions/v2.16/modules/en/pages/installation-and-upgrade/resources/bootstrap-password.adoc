...
:page-community-path: getting-started/installation-and-upgrade/resources/bootstrap-password.adoc 
:page-product-path: installation-and-upgrade/resources/bootstrap-password.adoc

...
:page-community-path: getting-started/installation-and-upgrade/install-upgrade-on-a-kubernetes-cluster/upgrades.adoc 
:page-product-path: installation-and-upgrade/upgrades.adoc

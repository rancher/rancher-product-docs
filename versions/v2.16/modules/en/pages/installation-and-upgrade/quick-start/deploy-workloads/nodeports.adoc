...
:page-community-path: getting-started/quick-start-guides/deploy-workloads/nodeports.adoc 
:page-product-path: installation-and-upgrade/quick-start/deploy-workloads/nodeports.adoc

...
:page-community-path: how-to-guides/new-user-guides/kubernetes-cluster-setup/high-availability-installs.adoc 
:page-product-path: installation-and-upgrade/best-practices/high-availability-installs.adoc
...
For information on how Rancher works, regardless of the installation method, refer to the {xref-rancher-architecture}[architecture section.]

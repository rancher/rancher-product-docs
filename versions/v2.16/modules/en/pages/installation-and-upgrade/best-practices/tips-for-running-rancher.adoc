...
:page-community-path: reference-guides/best-practices/rancher-server/tips-for-running-rancher.adoc 
:page-product-path: installation-and-upgrade/best-practices/tips-for-running-rancher.adoc

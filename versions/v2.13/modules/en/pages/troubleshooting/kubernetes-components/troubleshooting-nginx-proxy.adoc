...
:community-path: troubleshooting/kubernetes-components/troubleshooting-nginx-proxy 
:product-path: troubleshooting/kubernetes-components/troubleshooting-nginx-proxy

...
:community-path: how-to-guides/advanced-user-guides/compliance-scan-guides/enable-alerting-for-rancher-compliance 
:product-path: security/compliance-scans/enable-alerting-for-rancher-compliance

...
:community-path: how-to-guides/advanced-user-guides/compliance-scan-guides/install-rancher-compliance 
:product-path: security/compliance-scans/install-rancher-compliance
:experimental:

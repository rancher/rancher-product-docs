...
:community-path: how-to-guides/advanced-user-guides/enable-experimental-features/continuous-delivery 
:product-path: rancher-admin/experimental-features/continuous-delivery

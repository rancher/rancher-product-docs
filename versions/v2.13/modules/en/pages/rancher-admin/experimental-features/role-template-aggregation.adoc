...
:community-path: how-to-guides/advanced-user-guides/enable-experimental-features/role-template-aggregation 
:product-path: rancher-admin/experimental-features/role-template-aggregation

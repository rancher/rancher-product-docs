...
:page-community-path: how-to-guides/new-user-guides/authentication-permissions-and-global-configuration/manage-role-based-access-control-rbac/global-resources.adoc 
:page-product-path: rancher-admin/users/authn-and-authz/manage-role-based-access-control-rbac/global-resources.adoc
...
| Creation triggers refresh of group membership for specific or all users

| ext.cattle.io 
| kubeconfigs 
| Kubeconfig file for access to remote clusters

| ext.cattle.io 
| passwordchangerequests 
| Creation triggers update of the referenced User’s password

| ext.cattle.io 
| selfusers 
| Get delivers User making the request

| ext.cattle.io 
| tokens 
| Raw API key. See Kubeconfig for wrapped API keys

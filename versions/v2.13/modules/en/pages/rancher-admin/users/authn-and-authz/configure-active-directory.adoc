...
:community-path: how-to-guides/new-user-guides/authentication-permissions-and-global-configuration/authentication-config/configure-active-directory 
:product-path: rancher-admin/users/authn-and-authz/configure-active-directory

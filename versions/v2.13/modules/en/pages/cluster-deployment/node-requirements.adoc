...
When {xref-launch-k8s-with-rancher}[Launching Kubernetes with Rancher] using Flatcar Container Linux nodes, it is required to use the following configuration in the xref:./configuration/rke1.adoc#_rke_cluster_config_file_reference[Cluster Config File]

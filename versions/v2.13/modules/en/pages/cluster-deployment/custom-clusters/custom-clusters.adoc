...
. Use the *Cluster Configuration* section to set up the cluster. For more information, see xref:cluster-deployment/configuration/rke2.adoc[RKE2 Cluster Configuration Reference] and xref:cluster-deployment/configuration/k3s.adoc[K3s Cluster Configuration Reference].
+
[NOTE]
.Windows nodes
====

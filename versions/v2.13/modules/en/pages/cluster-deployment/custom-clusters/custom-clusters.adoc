...
.Windows nodes
====
To learn more about using Windows nodes as Kubernetes workers, see xref:cluster-deployment/custom-clusters/windows/use-windows-clusters.adoc[Launching Kubernetes on Windows Clusters].
====
+
. Click *Create*.
+

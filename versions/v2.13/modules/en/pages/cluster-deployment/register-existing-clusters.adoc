...
:community-path: how-to-guides/new-user-guides/kubernetes-clusters-in-rancher-setup/register-existing-clusters 
:product-path: cluster-deployment/register-existing-clusters

...
:community-path: reference-guides/cluster-configuration/rancher-server-configuration/k3s-cluster-configuration 
:product-path: cluster-deployment/configuration/k3s

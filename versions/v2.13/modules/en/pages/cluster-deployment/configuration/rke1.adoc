...
:community-path: reference-guides/cluster-configuration/rancher-server-configuration/rke1-cluster-configuration 
:product-path: cluster-deployment/configuration/rke1

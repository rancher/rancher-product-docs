...
:community-path: how-to-guides/new-user-guides/kubernetes-clusters-in-rancher-setup/set-up-clusters-from-hosted-kubernetes-providers/eks 
:product-path: cluster-deployment/hosted-kubernetes/eks/eks

...
:community-path: reference-guides/cluster-configuration/rancher-server-configuration/sync-clusters 
:product-path: cluster-deployment/hosted-kubernetes/sync-clusters

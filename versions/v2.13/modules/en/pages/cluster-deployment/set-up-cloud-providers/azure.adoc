...
. Under the *+Add* menu dropdown, Select *App registrations*.
. Select *New application registration*.
. Create a *Name*, select `Web app / API` as *Application Type* and a *Sign-on URL* which can be anything in this case.
. Select *Create*.
...
Next, assign the appropriate permissions to your App registration.

...
:community-path: reference-guides/cluster-configuration/downstream-cluster-configuration/machine-configuration/azure 
:product-path: cluster-deployment/infra-providers/azure/machine-configuration

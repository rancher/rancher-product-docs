...
:community-path: how-to-guides/new-user-guides/manage-clusters/access-clusters/use-kubectl-and-kubeconfig 
:product-path: cluster-admin/manage-clusters/access-clusters/use-kubectl-and-kubeconfig

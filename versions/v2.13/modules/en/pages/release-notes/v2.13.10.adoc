...
:release-version: v2.13.10
:rn-component-version: v2.13
:previous-release-version: v2.13.9
...
* The GKE provisioning UI now excludes Kubernetes versions that are not supported by any GKE release channel, reducing provisioning failures caused by selecting invalid versions. See https://github.com/rancher/dashboard/issues/18930[#18930].

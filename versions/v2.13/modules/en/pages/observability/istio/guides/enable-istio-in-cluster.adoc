...
:community-path: how-to-guides/advanced-user-guides/istio-setup-guide/enable-istio-in-cluster 
:product-path: observability/istio/guides/enable-istio-in-cluster

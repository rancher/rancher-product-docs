...
This guide assumes you have already xref:installation-and-upgrade/installation-and-upgrade.adoc[installed Rancher,] and you have already {xref-cluster-deployment}[provisioned a separate Kubernetes cluster] on which you will install Istio.

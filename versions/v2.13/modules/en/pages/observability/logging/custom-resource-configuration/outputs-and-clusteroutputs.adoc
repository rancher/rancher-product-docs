...
:community-path: integrations-in-rancher/logging/custom-resource-configuration/outputs-and-clusteroutputs 
:product-path: observability/logging/custom-resource-configuration/outputs-and-clusteroutputs

...
:page-community-path: integrations-in-rancher/logging/custom-resource-configuration/flows-and-clusterflows.adoc 
:page-product-path: observability/logging/custom-resource-configuration/flows-and-clusterflows.adoc

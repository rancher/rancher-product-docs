...
:community-path: getting-started/installation-and-upgrade/install-upgrade-on-a-kubernetes-cluster/troubleshooting 
:product-path: installation-and-upgrade/troubleshooting/troubleshooting

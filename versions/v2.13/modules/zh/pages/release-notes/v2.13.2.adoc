...
:rn-istio-istio: https://ranchermanager.docs.rancher.com/{rn-component-version}/integrations-in-rancher/istio
...
ifeval::["{build-type}" != "community"]
:rn-istio-istio: xref:observability/istio/istio.adoc
...
[IMPORTANT]
====
{rn-istio-istio}[Rancher-Istio] has been deprecated in Rancher v2.12.0; turn to the https://apps.rancher.io[SUSE Application Collection] build of Istio for enhanced security (included in SUSE Rancher Prime subscriptions). Detailed information can be found in https://forums.suse.com/t/deprecation-of-rancher-istio/45043[this announcement].
====

...
*  A known issue occurs in airgapped Harvester installations where the `ui-plugin-catalog` container `Compressed Endpoint` prevents installation. See https://github.com/rancher/rancher/issues/54658[#54658].

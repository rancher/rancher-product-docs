...
In this section, you'll learn how to use Rancher to provision an https://documentation.suse.com/cloudnative/rke2/[RKE2] Kubernetes cluster on the Google Cloud Platform (GCP) using Google Compute Engine (GCE) through Rancher.

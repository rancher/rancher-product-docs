 ...
 ** Security group: `K8sMasterSg` More info at link:../../../installation-and-upgrade/requirements/port-requirements.adoc#downstream-kubernetes-cluster-nodes[RKE ports (custom nodes tab)]
 ** Tags:
...
* Security group: `K8sWorkerSg` More info at link:../../../installation-and-upgrade/requirements/port-requirements.adoc#downstream-kubernetes-cluster-nodes[RKE ports (custom nodes tab)]
* Tags:
 ** `kubernetes.io/cluster/<clusterID>: owned`

...
For details on how to set up the newly created storage in Rancher, refer to the section on xref:../set-up-existing-storage.adoc[setting up existing storage.]

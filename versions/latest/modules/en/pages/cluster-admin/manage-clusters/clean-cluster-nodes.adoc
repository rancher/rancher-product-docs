...
. <<_docker_containers_images_and_volumes,Remove>> the Docker containers from the node and <<mounts,unmount>> any volumes.
. Reboot the node.
...
[pass]
<h3><a class="anchor" href="#_windows_nodes"></a>Windows Nodes</h3>
...
[pass]
<h3><a class="anchor" href="#_docker_containers_images_and_volumes"></a>Docker Containers, Images, and Volumes</h3>
...
[pass]
<h3><a class="anchor" href="#_mounts"></a>Mounts</h3>
...
[pass]
<h3><a class="anchor" href="#_removing_rancher-system-agent"></a>Removing rancher-system-agent</h3>
...
[pass]
<h3><a class="anchor" href="#_removing_rke2"></a>Removing RKE2</h3>
...
[pass]
<h3><a class="anchor" href="#_removing_k3s"></a>Removing K3s</h3>

...
* xref:manage-clusters/persistent-storage/manage-persistent-storage.adoc[Persistent Volume Claims]
...
When working with project resources that you can assign to a namespace (i.e., xref:kubernetes-resources/workloads-and-pods/deploy-workloads.adoc[workloads], xref:../security/encrypting-http.adoc[certificates], xref:kubernetes-resources/configmaps.adoc[ConfigMaps], etc.) you can create a namespace on the fly.
====
...
. *Optional:* If your project has xref:project-admin/project-resource-quotas/project-resource-quotas.adoc[Resource Quotas] in effect, you can override the default resource *Limits* (which places a cap on the resources that the namespace can consume).
 ...
 ** You cannot move a namespace into a project that already has a xref:project-admin/project-resource-quotas/project-resource-quotas.adoc[resource quota]configured.
...
For more information, see how to xref:project-admin/project-resource-quotas/override-default-limit-in-namespaces.adoc[edit namespace resource quotas].

...
| 29 Jan 2019
| https://github.com/rancher/rancher/releases/tag/v2.1.6[Rancher v2.1.6] and https://github.com/rancher/rancher/releases/tag/v2.0.11[Rancher v2.0.11] - Rolling back from these versions or greater have specific xref:../installation-and-upgrade/installation/rollbacks.adoc[instructions].
|===

...
| Kubernetes v1.23
| CIS v1.23
| xref:rke1/self-assessment-guide-with-cis-v1.23-k8s-v1.23.adoc[Link]
| xref:rke1/rke1.adoc[Link]

| Kubernetes v1.24
| CIS v1.24
| xref:rke1/self-assessment-guide-with-cis-v1.24-k8s-v1.24.adoc[Link]
| xref:rke1/rke1.adoc[Link]

| Kubernetes v1.25/v1.26/v1.27
| CIS v1.7
| xref:rke1/self-assessment-guide-with-cis-v1.7-k8s-v1.25-v1.26-v1.27.adoc[Link]
| xref:rke1/rke1.adoc[Link]
|===
...
| Kubernetes v1.23
| CIS v1.23
| xref:rke2/self-assessment-guide-with-cis-v1.23-k8s-v1.23.adoc[Link]
| xref:rke2/rke2.adoc[Link]

| Rancher provisioned RKE2
| Kubernetes v1.24
| CIS v1.24
| xref:rke2/self-assessment-guide-with-cis-v1.24-k8s-v1.24.adoc[Link]
| xref:rke2/rke2.adoc[Link]

| Rancher provisioned RKE2
| Kubernetes v1.25/v1.26/v1.27
| CIS v1.7
| xref:rke2/self-assessment-guide-with-cis-v1.7-k8s-v1.25-v1.26-v1.27.adoc[Link]
| xref:rke2/rke2.adoc[Link]
...
| Kubernetes v1.23
| CIS v1.23
| xref:k3s/self-assessment-guide-with-cis-v1.23-k8s-v1.23.adoc[Link]
| xref:k3s/k3s.adoc[Link]

| Rancher provisioned K3s cluster
| Kubernetes v1.24
| CIS v1.24
| xref:k3s/self-assessment-guide-with-cis-v1.24-k8s-v1.24.adoc[Link]
| xref:k3s/k3s.adoc[Link]

| Rancher provisioned K3s cluster
| Kubernetes v1.25/v1.26/v1.27
| CIS v1.7
| xref:k3s/self-assessment-guide-with-cis-v1.7-k8s-v1.25-v1.26-v1.27.adoc[Link]
| xref:k3s/k3s.adoc[Link]

...
[pass]
<h3><a class="anchor" href="#_assign_a_template_to_an_existing_cluster"></a>Assign a Template to an Existing Cluster</h3>
...
[pass]
<h3><a class="anchor" href="#_hardening_the_cluster"></a>Hardening the Cluster</h3>

...
This section describes how to use `firewalld` to apply the xref:installation-and-upgrade/requirements/installation-requirements.adoc#_port_requirements[firewall port rules] for nodes in a high-availability Rancher server cluster.

...
The intent of these guides is to quickly launch a sandbox that you can use to evaluate Rancher. The Docker install is not recommended for production environments. For comprehensive setup instructions, see xref:../../installation-and-upgrade.adoc[Installation].
====
...
* Provision the host according to our xref:../../requirements/installation-requirements.adoc[Requirements].
====

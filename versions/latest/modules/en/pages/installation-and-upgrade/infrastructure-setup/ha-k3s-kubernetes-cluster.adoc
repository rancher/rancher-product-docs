...
For more information about each installation option, refer to xref:../installation-and-upgrade.adoc[this page.]
...
Make sure that your nodes fulfill the general installation requirements for xref:../requirements/installation-requirements.adoc[OS, container runtime, hardware, and networking.]

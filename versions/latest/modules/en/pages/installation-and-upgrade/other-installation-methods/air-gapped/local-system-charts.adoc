...
Example commands for a Rancher installation with a bundled `system-charts` are included in the xref:air-gapped.adoc[air gap installation] instructions for Docker and Helm installs.

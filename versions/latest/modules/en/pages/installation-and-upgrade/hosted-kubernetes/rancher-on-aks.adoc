...
* Your subscription has sufficient quota for at least 2 vCPUs. For details on Rancher server resource requirements, refer to xref:installation-and-upgrade/requirements/installation-requirements.adoc[this section]

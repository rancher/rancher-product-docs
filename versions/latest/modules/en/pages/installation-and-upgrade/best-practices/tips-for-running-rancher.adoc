...
If you are installing Rancher in a vSphere environment, refer to the best practices documented xref:rancher-on-vsphere.adoc[here.]
...
The Rancher server's Kubernetes cluster should run within the xref:../requirements/installation-requirements.adoc[system and hardware requirements] as closely as possible. The more you deviate from the system and hardware requirements, the more risk you take.

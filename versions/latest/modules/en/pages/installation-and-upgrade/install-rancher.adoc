...
* *RKE2:* For the tutorial to install an RKE2 Kubernetes cluster, refer to xref:installation-and-upgrade/install-kubernetes/rke2-for-rancher.adoc[this page.] For help setting up the infrastructure for a high-availability RKE2 cluster, refer to xref:installation-and-upgrade/infrastructure-setupp/ha-rke2-kubernetes-cluster.adoc[this page.]

...
For systems without direct internet access, refer to xref:../other-installation-methods/air-gapped/air-gapped.adoc[Air Gap: Kubernetes install.]
...
For tuning your etcd cluster for larger Rancher installations, see the xref:../best-practices/tuning-etcd-for-large-installs.adoc[etcd settings guide].

For more information regarding Dockershim support, refer to xref:../requirements/dockershim.adoc[this page]
====
...
See the xref:../troubleshooting/troubleshooting.adoc[Troubleshooting] page.

...
These instructions assume you have set up three nodes, a load balancer, and a DNS record, as described in xref:installation-and-upgrade/infrastructure-setupp/ha-rke2-kubernetes-cluster.adoc[this section.]

...
NOTE: Refer to the xref:backup.adoc[backup config reference page] for more information on configuring the options below.
...
NOTE: Refer to the xref:restore.adoc[restore config reference page] for more information on configuring the options below.

...
* xref:ms-adfs-for-rancher.adoc[1. Configuring Microsoft AD FS for Rancher]
* xref:rancher-for-ms-adfs.adoc[2. Configuring Rancher for Microsoft AD FS]
...
=== xref:ms-adfs-for-rancher.adoc[Next: Configuring Microsoft AD FS for Rancher]

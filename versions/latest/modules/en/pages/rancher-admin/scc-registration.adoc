...
Since Rancher v2.12.1, SUSE Rancher Prime customers can now register Rancher Manager with [SUSE Customer Center (SCC)](https://scc.suse.com/home). This registration provides access to add-ons, software updates and patches included in your organization's subscriptions.

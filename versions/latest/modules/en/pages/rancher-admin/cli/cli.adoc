...
* An API Bearer Token, which is used to authenticate with Rancher. For more information about obtaining a Bearer Token, see xref:rancher-admin/user/settings/api-keys.adoc[Creating an API Key].

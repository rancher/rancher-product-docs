...
As these are legacy features, please see the Rancher v2.0--v2.4 docs on xref:[catalogs], link:/versioned_docs/version-2.0-2.4/how-to-guides/new-user-guides/helm-charts-in-rancher/globaldns.adoc#adding-a-global-dns-entry[global DNS entries], and link:/versioned_docs/version-2.0-2.4/how-to-guides/new-user-guides/helm-charts-in-rancher/globaldns.adoc#editing-a-global-dns-provider[global DNS providers] for more details.

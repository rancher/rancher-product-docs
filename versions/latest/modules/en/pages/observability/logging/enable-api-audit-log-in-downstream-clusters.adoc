...
--
[pass]
<h2><a class="anchor" href="#_method_1_recommended_set_audit-policy-file_in_machineglobalconfig"></a>Method 1 (Recommended): Set `audit-policy-file` in `machineGlobalConfig`</h2>
...
[pass]
<h2><a class="anchor" href="#_method_2_use_the_directives_machineselectorfiles_and_machineglobalconfig"></a>Method 2: Use the Directives, `machineSelectorFiles` and `machineGlobalConfig`</h2>
...
As a prerequisite, you must create a xref:../new-user-guides/kubernetes-resources-setup/secrets.adoc[secret] or xref:../new-user-guides/kubernetes-resources-setup/configmaps.adoc[configmap] to be the source of the audit policy.
...
For more information about cluster configuration, refer to the xref:../../reference-guides/cluster-configuration/rancher-server-configuration/rke2-cluster-configuration.adoc[RKE2 cluster configuration reference] pages.
--
...
Rancher Dashboard provides an easy-to-use form for creating the xref:../new-user-guides/kubernetes-resources-setup/secrets.adoc[secret] or xref:../new-user-guides/kubernetes-resources-setup/configmaps.adoc[configmap].
====
...
For more information about cluster configuration, refer to the xref:../../reference-guides/cluster-configuration/rancher-server-configuration/k3s-cluster-configuration.adoc[K3s cluster configuration reference] pages.
--

...
This section assumes familiarity with how monitoring components work together. For more information about Alertmanager, see link:../../how-monitoring-works.adoc#3-how-alertmanager-works[this section.]
====

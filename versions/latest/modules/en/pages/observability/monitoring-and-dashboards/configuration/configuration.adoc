...
The resource requests and limits for the monitoring application can be configured when installing `rancher-monitoring`. For more information about the default limits, see link:helm-chart-options.adoc#configuring-resource-limits-and-requests[this page.]
...
For details, see xref:servicemonitors-and-podmonitors.adoc[this page.]

=== Advanced Prometheus Configuration

For more information about directly editing the Prometheus custom resource, which may be helpful in advanced use cases, see xref:advanced/prometheus.adoc[this page.]
...
For some advanced use cases, you may want to configure alertmanager directly. For more information, refer to xref:advanced/alertmanager.adoc[this page.]

=== Receivers

Receivers are used to set up notifications. For details on how to configure receivers, see xref:receivers.adoc[this page.]

=== Routes

Routes filter notifications before they reach receivers. Each route needs to refer to a receiver that has already been configured. For details on how to configure routes, see xref:routes.adoc[this page.]

=== Advanced

For more information about directly editing the Alertmanager custom resource, which may be helpful in advanced use cases, see xref:advanced/alertmanager.adoc[this page.]

...
. Locate Rancher's built-in Nutanix link:../../../rancher-admin/global-configuration/provisioning-drivers/manage-node-drivers.adoc#activatingdeactivating-node-drivers[node driver and activate it].
...
Creating a link:../infra-providers.adoc#node-templates[node template] for Nutanix AOS will allow Rancher to provision new nodes in Nutanix AOS. Node templates can be reused for other clusters.

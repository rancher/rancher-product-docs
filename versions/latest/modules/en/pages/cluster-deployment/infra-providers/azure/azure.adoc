...
For more information on configuring the Kubernetes cluster that Rancher will install on the Azure nodes, refer to the xref:../../configuration/rke1.adoc[RKE cluster configuration reference.]

For more information on configuring Azure node templates, refer to the xref:node-template-configuration.adoc[Azure node template configuration reference.]

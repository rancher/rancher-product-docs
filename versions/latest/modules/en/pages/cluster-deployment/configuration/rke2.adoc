...
The default xref:security/psp/create.adoc[pod security policy] for the cluster. Please refer to the https://documentation.suse.com/cloudnative/rke2/latest/en/security/pod_security_policies.html[RKE2 documentation] on the specifications of each available policy.

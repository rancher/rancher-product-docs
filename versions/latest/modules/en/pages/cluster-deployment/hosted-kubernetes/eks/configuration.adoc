...
| Cloud Credentials
| Select the cloud credentials that you created for your IAM policy. For more information on creating cloud credentials in Rancher, refer to xref:../../../rancher-admin/user/settings/manage-cloud-credentials.adoc[this page.]
|===

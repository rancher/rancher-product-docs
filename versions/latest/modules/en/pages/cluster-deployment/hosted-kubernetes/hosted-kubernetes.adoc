...
* xref:gke/gke.adoc[Creating a GKE Cluster]
* xref:eks/eks.adoc[Creating an EKS Cluster]
* xref:aks/aks.adoc[Creating an AKS Cluster]
* xref:../../how-to-guides/new-user-guides/kubernetes-clusters-in-rancher-setup/set-up-clusters-from-hosted-kubernetes-providers/alibaba.adoc[Creating an ACK Cluster]
* xref:../../how-to-guides/new-user-guides/kubernetes-clusters-in-rancher-setup/set-up-clusters-from-hosted-kubernetes-providers/tencent.adoc[Creating a TKE Cluster]
* xref:../../how-to-guides/new-user-guides/kubernetes-clusters-in-rancher-setup/set-up-clusters-from-hosted-kubernetes-providers/huawei.adoc[Creating a CCE Cluster]

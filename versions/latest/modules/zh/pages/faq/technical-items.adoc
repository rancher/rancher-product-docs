...
你可以使用集群选项中的link:../cluster-deployment/configuration/rke1.adoc#rke-集群配置文件参考[配置文件]选项来添加其他参数/​​绑定/环境变量。有关详细信息，请参阅 RKE 文档中的https://rancher.com/docs/rke/latest/en/config-options/services/services-extras/[其他参数、绑定和环境变量]，或浏览 https://rancher.com/docs/rke/latest/en/example-yamls/[Cluster.ymls 示例]。

...
image:neuvector-security-containers.png[NeuVector 安全容器]+++<figcaption>+++**NeuVector 架构：**+++</figcaption>+++
...
+
image::/img/psp-nv-rke.png[为 RKE1 强化集群启用 PSP]
...
+
image::/img/psp-nv-rke2.png[为 RKE2 和 K3s 强化集群启用 PSP]

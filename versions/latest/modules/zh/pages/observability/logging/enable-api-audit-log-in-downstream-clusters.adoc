...
在此之前，你需要创建 link:../../security/secrets-hub.adoc[Secret] 或 link:../../cluster-admin/kubernetes-resources/configmaps.adoc[ConfigMap] 作为审计策略的来源。
...
有关集群配置的更多信息，请参阅 link:../../cluster-deployment/configuration/rke2.adoc[RKE2 集群配置参考]页面。
--
...
Rancher Dashboard 提供了易于使用的表单页面用于创建 link:../../security/secrets-hub.adoc[Secret] 或 link:../../cluster-admin/kubernetes-resources/configmaps.adoc[ConfigMap]。
====
...
有关集群配置的更多信息，请参阅 link:../../cluster-deployment/configuration/k3s.adoc[K3s 集群配置参考] 页面。
--

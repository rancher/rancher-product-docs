...
要查看和自定义用于支持 Grafana 仪表板的 PromQL 查询，请参阅xref:customizing-dashboard/customize-grafana-dashboard.adoc[此页面]。

=== 持久化 Grafana 仪表板

要创建持久化 Grafana 仪表板，请参阅xref:customizing-dashboard/create-persistent-grafana-dashboard.adoc[此页面]。
...
有关在 Rancher 中配置 Alertmanager 的更多信息，请参阅xref:configuration/advanced/alertmanager.adoc[此页面]。+++<figcaption>+++Alertmanager UI+++</figcaption>+++
...
有关在 Rancher 中配置 PrometheusRule 的更多信息，请参阅xref:configuration/advanced/prometheusrules.adoc[此页面]。

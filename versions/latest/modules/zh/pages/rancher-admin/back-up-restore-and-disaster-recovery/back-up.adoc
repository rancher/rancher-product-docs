...
. 要使用该表单配置 Backup 详细信息，请单击**创建**，然后参见xref:rancher-admin/back-up-restore-and-disaster-recovery/configuration/backup.adoc[配置参考]和link:configuration/examples.adoc#备份[示例]进行操作。
...
+
如需获得配置 Backup 的帮助，请参见xref:rancher-admin/back-up-restore-and-disaster-recovery/configuration/backup.adoc[配置参考]和link:configuration/examples.adoc#备份[示例]。
+

...
====
+
默认的 `active` xref:../../global-configuration/provisioning-drivers/manage-node-drivers.adoc[主机驱动]和任何标记了 `password` 字段的主机驱动都需要使用xref:../../../cluster-deployment/infra-providers/infra-providers.adoc#_云凭证[云凭证]。
+
====

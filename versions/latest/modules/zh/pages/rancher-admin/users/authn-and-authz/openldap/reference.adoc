...
如果你不确定要在用户/组``搜索库``字段中输入什么值，请咨询你的 LDAP 管理员，或参见 Active Directory 身份验证文档中的link:../configure-active-directory.adoc#附录使用-ldapsearch-确定搜索库和-schema[使用 ldapsearch 确定搜索库和 Schema] 章节。+++<figcaption>+++OpenLDAP 服务器参数+++</figcaption>+++
...
如果你不确定 OpenLDAP 服务器中使用的用户/组 Schema，请咨询你的 LDAP 管理员，或参见 Active Directory 身份验证文档中的link:../configure-active-directory.adoc#附录使用-ldapsearch-确定搜索库和-schema[使用 ldapsearch 确定搜索库和 Schema] 章节。

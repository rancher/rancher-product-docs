 ...
 ** 安全组：`K8sMasterSg`。详情请参见 link:../../../installation-and-upgrade/requirements/port-requirements.adoc#下游-kubernetes-集群节点[RKE 端口（自定义节点选项卡）]
 ** 标签：
...
* 安全组：`K8sWorkerSg`。详情请参见 link:../../../installation-and-upgrade/requirements/port-requirements.adoc#下游-kubernetes-集群节点[RKE 端口（自定义节点选项卡）]
* 标签：
 ** `kubernetes.io/cluster/<clusterID>: owned`

...
:page-community-path: faq/security.adoc 
:page-product-path: faq/security.adoc
...
The Hardening Guide is located in the main {xref-security-overview}[Security] section.
...
We have run the CIS Kubernetes benchmark against a hardened Rancher Kubernetes cluster.  The results of that assessment can be found in the main {xref-security-overview}[Security] section.

...
:page-community-path: how-to-guides/advanced-user-guides/open-ports-with-firewalld.adoc 
:page-product-path: security/open-ports-with-firewalld.adoc
ifeval::["{build-type}" != "community"]
:url-firewalld-conflicts: https://documentation.suse.com/cloudnative/rke2/latest/en/known_issues.html#_firewalld_conflicts_with_default_networking
:xref-install-reqs: xref:installation-and-upgrade/requirements/requirements.adoc
endif::[]
ifeval::["{build-type}" == "community"]
:url-firewalld-conflicts: https://docs.rke2.io/known_issues#firewalld-conflicts-with-default-networking
...
For proper network function, firewalld must be disabled on systems running RKE2. {url-firewalld-conflicts}[Firewalld conflicts with Canal], RKE2's default networking stack.

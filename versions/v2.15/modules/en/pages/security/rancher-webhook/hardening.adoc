...
:page-community-path: reference-guides/rancher-security/rancher-webhook-hardening.adoc 
:page-product-path: security/rancher-webhook/hardening.adoc
ifeval::["{build-type}" != "community"]
:url-rke2-pod-security-standards: https://documentation.suse.com/cloudnative/rke2/latest/en/security/pod_security_standards.html
endif::[]
ifeval::["{build-type}" == "community"]
:url-rke2-pod-security-standards: https://docs.rke2.io/security/pod_security_standards
endif::[]
...
----
+
This is also the same config file where other admission plugins are configured, such as PodSecurity. If your distro or your setup uses additional admission plugins, configure those as well. For example, add {url-rke2-pod-security-standards}[RKE2's PodSecurity configuration] to this file.

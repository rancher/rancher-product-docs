...
:page-community-path: getting-started/installation-and-upgrade/resources/helm-version-requirements.adoc 
:page-product-path: installation-and-upgrade/requirements/helm-version-requirements.adoc

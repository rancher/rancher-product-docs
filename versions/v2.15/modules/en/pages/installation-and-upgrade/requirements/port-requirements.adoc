...
:page-community-path: getting-started/installation-and-upgrade/installation-requirements/port-requirements.adoc 
:page-product-path: installation-and-upgrade/requirements/port-requirements.adoc

...
:page-community-path: getting-started/installation-and-upgrade/install-upgrade-on-a-kubernetes-cluster/rollbacks.adoc 
:page-product-path: installation-and-upgrade/rollbacks.adoc
:experimental:
...
[#_step_1_clean_up_the_upstream_local_cluster]
...
[#_step_2_restore_the_backup_and_bring_up_rancher]

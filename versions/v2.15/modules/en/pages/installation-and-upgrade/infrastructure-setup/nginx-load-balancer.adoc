...
:page-community-path: how-to-guides/new-user-guides/infrastructure-setup/nginx-load-balancer.adoc 
:page-product-path: installation-and-upgrade/infrastructure-setup/nginx-load-balancer.adoc

...
:page-community-path: how-to-guides/new-user-guides/infrastructure-setup/nodes-in-amazon-ec2.adoc 
:page-product-path: installation-and-upgrade/infrastructure-setup/nodes-in-amazon-ec2.adoc
:experimental:

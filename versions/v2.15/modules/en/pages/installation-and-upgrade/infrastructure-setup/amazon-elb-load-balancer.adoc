...
:page-community-path: how-to-guides/new-user-guides/infrastructure-setup/amazon-elb-load-balancer.adoc 
:page-product-path: installation-and-upgrade/infrastructure-setup/amazon-elb-load-balancer.adoc

...
:page-community-path: how-to-guides/advanced-user-guides/rancher-deployment-guides/configure-with-existing-gateway.adoc
:page-product-path: installation-and-upgrade/infrastructure-setup/configure-with-existing-gateway.adoc

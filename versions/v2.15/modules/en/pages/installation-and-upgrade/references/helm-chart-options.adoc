...
:page-community-path: getting-started/installation-and-upgrade/installation-references/helm-chart-options.adoc 
:page-product-path: installation-and-upgrade/references/helm-chart-options.adoc
...
| `false`
| `bool` - Sets the default value of the `system-default-registry-pull-secrets` global setting to a comma-separated list of the `imagePullSecrets` used when installing Rancher. For details, see {xref-private-registries}[configuring a global default private registry].
|===

...
| `false`
| `bool` - Set the default value of the `system-default-registry-pull-secrets` global setting to a comma separated list of the `imagePullSecrets` used when installing Rancher. See {xref-private-registries}[Global Registry documentation] for more details.
|===

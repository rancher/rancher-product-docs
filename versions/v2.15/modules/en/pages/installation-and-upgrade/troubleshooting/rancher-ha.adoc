...
:page-community-path: troubleshooting/other-troubleshooting-tips/rancher-ha.adoc 
:page-product-path: installation-and-upgrade/troubleshooting/rancher-ha.adoc

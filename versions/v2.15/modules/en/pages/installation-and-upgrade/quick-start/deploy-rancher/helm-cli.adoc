...
:page-community-path: getting-started/quick-start-guides/deploy-rancher-manager/helm-cli.adoc 
:page-product-path: installation-and-upgrade/quick-start/deploy-rancher/helm-cli.adoc

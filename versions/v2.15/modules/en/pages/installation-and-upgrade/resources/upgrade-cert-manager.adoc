...
:page-community-path: getting-started/installation-and-upgrade/resources/upgrade-cert-manager.adoc 
:page-product-path: installation-and-upgrade/resources/upgrade-cert-manager.adoc
...
[pass]
<h3><a id="_install_cert_manager"></a>Install cert-manager</h3>

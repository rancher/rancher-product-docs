...
:page-community-path: reference-guides/best-practices/rancher-server/on-premises-rancher-in-vsphere.adoc 
:page-product-path: installation-and-upgrade/best-practices/rancher-on-vsphere.adoc

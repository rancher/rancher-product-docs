...
:page-community-path: integrations-in-rancher/longhorn/overview.adoc 
:page-product-path: integrations/longhorn/overview.adoc
...
:url-storage-concepts: https://documentation.suse.com/cloudnative/storage/{longhorn-docs-version}/en/introduction/concepts.html
:url-storage-requirements: https://documentation.suse.com/cloudnative/storage/{longhorn-docs-version}/en/installation-setup/requirements.html
:url-storage-settings: https://documentation.suse.com/cloudnative/storage/{longhorn-docs-version}/en/longhorn-system/settings.html
endif::[]
ifeval::["{build-type}" == "community"]
:url-storage-overview: https://longhorn.io/docs/{longhorn-docs-version}
:url-storage-concepts: https://longhorn.io/docs/{longhorn-docs-version}/concepts/
:url-storage-requirements: https://longhorn.io/docs/{longhorn-docs-version}/deploy/install/
:url-storage-settings: https://longhorn.io/docs/{longhorn-docs-version}/references/settings/
endif::[]
...
. Fulfill all {url-storage-requirements}[Installation Requirements.]
. Go to the cluster where you want to install Longhorn.
. Click *Apps*.
. Click *Charts*.
. Click *Longhorn*.
. Optional: To customize the initial settings, click *Longhorn Default Settings* and edit the configuration. For help customizing the settings, refer to the {url-storage-settings}[{longhorn-product-name} documentation.]
. Click *Install*.
...
The Longhorn documentation is {url-storage-overview}[here.]
...
You can learn more about its architecture {url-storage-concepts}[here.]

...
:page-community-path: integrations-in-rancher/neuvector/overview.adoc 
:page-product-path: integrations/neuvector/overview.adoc
:experimental:
ifeval::["{build-type}" != "community"]
:url-security-landing-page: https://documentation.suse.com/cloudnative/security/
:url-security-rancher-deployment: https://documentation.suse.com/cloudnative/security/{neuvector-docs-version}/en/rancher.html#_deploy_and_manage_suse_security_through_rancher_extensions_or_apps_marketplace
:url-security-architecture: https://documentation.suse.com/cloudnative/security/{neuvector-docs-version}/en/overview.html#_architecture
:xref-security-overview: xref:security/security-overview.adoc
endif::[]
ifeval::["{build-type}" == "community"]
:url-security-landing-page: https://open-docs.neuvector.com/
:url-security-rancher-deployment: https://open-docs.neuvector.com/deploying/rancher#deploy-and-manage-neuvector-through-rancher-apps--marketplace
:url-security-architecture: https://open-docs.neuvector.com/basics/overview#architecture
:xref-security-overview: xref:reference-guides/rancher-security/index.adoc
endif::[]

{url-security-landing-page}[NeuVector 5.x] is an open-source container-centric security platform that is integrated with Rancher. NeuVector offers real-time compliance, visibility, and protection for critical applications and data during runtime. NeuVector provides a firewall, container process/file system monitoring, security auditing with CIS benchmarks, and vulnerability scanning. For more information on Rancher security, please see the {xref-security-overview}[security documentation].

NeuVector can be enabled through a Helm chart that may be installed either through *Apps* or through the *Cluster Tools* button in the Rancher UI. Once the Helm chart is installed, users can easily {url-security-rancher-deployment}[deploy and manage NeuVector clusters within Rancher].
...
The NeuVector documentation is {url-security-landing-page}[here].
...
To learn more about NeuVector's architecture, please refer {url-security-architecture}[here].

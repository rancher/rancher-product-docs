...
:page-community-path: how-to-guides/new-user-guides/authentication-permissions-and-global-configuration/notification-center.adoc 
:page-product-path: rancher-admin/global-configuration/notification-center.adoc

...
:page-community-path: how-to-guides/new-user-guides/authentication-permissions-and-global-configuration/authenticated-private-registries.adoc
:page-product-path: rancher-admin/global-configuration/authenticated-private-registries.adoc

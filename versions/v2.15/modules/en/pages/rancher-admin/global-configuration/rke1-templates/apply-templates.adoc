...
:page-community-path: how-to-guides/new-user-guides/authentication-permissions-and-global-configuration/about-rke1-templates/apply-templates.adoc 
:page-product-path: rancher-admin/global-configuration/rke1-templates/apply-templates.adoc
...
You can create a cluster from an RKE template that you created, or from a template that has been {xref-access-share-rke1-templates}[shared with you.]
...
To add a cluster {xref-launch-k8s-with-rancher}[hosted by an infrastructure provider] using an RKE template, use these steps:

...
:page-community-path: how-to-guides/advanced-user-guides/ui-server-side-pagination.adoc 
:page-product-path: rancher-admin/global-configuration/ui-server-side-pagination.adoc

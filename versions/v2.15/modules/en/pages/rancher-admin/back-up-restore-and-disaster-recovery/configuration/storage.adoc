...
:page-community-path: reference-guides/backup-restore-configuration/storage-configuration.adoc 
:page-product-path: rancher-admin/back-up-restore-and-disaster-recovery/configuration/storage.adoc

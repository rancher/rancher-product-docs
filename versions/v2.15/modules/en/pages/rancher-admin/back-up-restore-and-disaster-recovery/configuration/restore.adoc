...
:page-community-path: reference-guides/backup-restore-configuration/restore-configuration.adoc 
:page-product-path: rancher-admin/back-up-restore-and-disaster-recovery/configuration/restore.adoc

...
[TIP]
====
You can find your exact Redirect URI in Rancher by navigating to the **Azure AD** authentication setup page (*Global View > Users & Authentication > Auth Provider > Microsoft Entra ID*).
====
...
. In Rancher, navigate to **☰ > Users & Authentication > Auth Provider > Microsoft Entra ID**.

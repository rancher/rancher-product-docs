...
:page-community-path: how-to-guides/advanced-user-guides/enable-user-retention.adoc 
:page-product-path: rancher-admin/users/authn-and-authz/enable-user-retention.adoc

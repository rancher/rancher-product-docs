...
:page-community-path: troubleshooting/kubernetes-components/troubleshooting-controlplane-nodes.adoc 
:page-product-path: troubleshooting/kubernetes-components/troubleshooting-controlplane-nodes.adoc

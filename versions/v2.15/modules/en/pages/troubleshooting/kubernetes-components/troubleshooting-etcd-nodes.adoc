...
:page-community-path: troubleshooting/kubernetes-components/troubleshooting-etcd-nodes.adoc 
:page-product-path: troubleshooting/kubernetes-components/troubleshooting-etcd-nodes.adoc
...
[#_check_connectivity_on_etcd_ports]

...
:page-community-path: troubleshooting/kubernetes-components/troubleshooting-nginx-proxy.adoc 
:page-product-path: troubleshooting/kubernetes-components/troubleshooting-nginx-proxy.adoc

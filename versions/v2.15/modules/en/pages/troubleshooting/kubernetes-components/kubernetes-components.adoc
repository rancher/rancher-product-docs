...
:page-community-path: troubleshooting/kubernetes-components/index.adoc 
:page-product-path: troubleshooting/kubernetes-components/kubernetes-components.adoc

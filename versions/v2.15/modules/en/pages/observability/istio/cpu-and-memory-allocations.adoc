...
:page-community-path: integrations-in-rancher/istio/cpu-and-memory-allocations.adoc 
:page-product-path: observability/istio/cpu-and-memory-allocations.adoc

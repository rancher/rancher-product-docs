...
:page-community-path: how-to-guides/advanced-user-guides/istio-setup-guide/set-up-istio-gateway.adoc 
:page-product-path: observability/istio/guides/set-up-istio-gateway.adoc

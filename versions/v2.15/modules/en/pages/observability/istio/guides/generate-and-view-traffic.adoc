...
:page-community-path: how-to-guides/advanced-user-guides/istio-setup-guide/generate-and-view-traffic.adoc 
:page-product-path: observability/istio/guides/generate-and-view-traffic.adoc

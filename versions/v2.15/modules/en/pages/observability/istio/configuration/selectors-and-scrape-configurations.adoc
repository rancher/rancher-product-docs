...
:page-community-path: integrations-in-rancher/istio/configuration-options/selectors-and-scrape-configurations.adoc 
:page-product-path: observability/istio/configuration/selectors-and-scrape-configurations.adoc

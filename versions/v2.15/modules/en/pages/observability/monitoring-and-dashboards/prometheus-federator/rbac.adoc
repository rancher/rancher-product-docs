...
:page-community-path: reference-guides/prometheus-federator/rbac.adoc 
:page-product-path: observability/monitoring-and-dashboards/prometheus-federator/rbac.adoc

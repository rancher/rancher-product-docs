...
:page-community-path: integrations-in-rancher/monitoring-and-alerting/how-monitoring-works.adoc 
:page-product-path: observability/monitoring-and-dashboards/how-monitoring-works.adoc

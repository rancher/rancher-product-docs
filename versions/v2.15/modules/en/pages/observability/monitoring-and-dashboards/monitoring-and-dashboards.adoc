...
If installing using the UI, make sure to fill all the fields under **Project Monitoring Chart** and **Grafana Chart**. This changes the **image**, not the chart. At the moment it is not possible to choose what version of the Grafana chart is installed.

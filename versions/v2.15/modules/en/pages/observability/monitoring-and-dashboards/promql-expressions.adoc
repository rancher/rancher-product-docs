...
:page-community-path: integrations-in-rancher/monitoring-and-alerting/promql-expressions.adoc 
:page-product-path: observability/monitoring-and-dashboards/promql-expressions.adoc

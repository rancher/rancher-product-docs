...
:page-community-path: reference-guides/cluster-configuration/downstream-cluster-configuration/machine-configuration/amazon-ec2.adoc 
:page-product-path: cluster-deployment/infra-providers/aws/machine-configuration.adoc

...
:page-community-path: troubleshooting/other-troubleshooting-tips/registered-clusters.adoc 
:page-product-path: cluster-deployment/register-existing-clusters-troubleshooting.adoc

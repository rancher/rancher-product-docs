...
:page-community-path: how-to-guides/new-user-guides/kubernetes-clusters-in-rancher-setup/use-windows-clusters/index.adoc 
:page-product-path: cluster-deployment/custom-clusters/windows/use-windows-clusters.adoc

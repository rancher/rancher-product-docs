...
:page-community-path: how-to-guides/new-user-guides/kubernetes-clusters-in-rancher-setup/set-up-cloud-providers/configure-out-of-tree-vsphere.adoc 
:page-product-path: cluster-deployment/set-up-cloud-providers/configure-out-of-tree-vsphere.adoc
:experimental:

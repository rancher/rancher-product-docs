...
:page-community-path: how-to-guides/new-user-guides/launch-kubernetes-with-rancher/about-rancher-agents.adoc 
:page-product-path: cluster-deployment/about-rancher-agents.adoc

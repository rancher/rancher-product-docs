...
:page-community-path: reference-guides/rancher-manager-architecture/communicating-with-downstream-user-clusters.adoc 
:page-product-path: about-rancher/architecture/communicating-with-downstream-clusters.adoc

...
* Fleet now supports AppCo registries as a native Helm chart source, allowing you to deploy AppCo application bundles to downstream clusters using Fleet GitRepos and Bundles. See https://github.com/rancher/dashboard/issues/14627[#14627].

...
:page-community-path: how-to-guides/new-user-guides/manage-clusters/clean-cluster-nodes.adoc 
:page-product-path: cluster-admin/manage-clusters/clean-cluster-nodes.adoc

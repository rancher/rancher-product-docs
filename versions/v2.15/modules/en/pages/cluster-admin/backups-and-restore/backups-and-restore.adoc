...
:page-community-path: getting-started/installation-and-upgrade/upgrade-and-roll-back-kubernetes.adoc 
:page-product-path: cluster-admin/backups-and-restore/backups-and-restore.adoc
...
* Before upgrading Kubernetes, {xref-ds-backup}[back up your cluster.]
====

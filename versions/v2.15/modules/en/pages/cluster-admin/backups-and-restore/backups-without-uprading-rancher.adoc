...
:page-community-path: getting-started/installation-and-upgrade/upgrade-kubernetes-without-upgrading-rancher.adoc 
:page-product-path: cluster-admin/backups-and-restore/backups-without-uprading-rancher.adoc

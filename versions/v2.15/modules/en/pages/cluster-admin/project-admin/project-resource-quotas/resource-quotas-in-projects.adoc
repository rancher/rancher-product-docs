...
requested quota limit, use the `field.cattle.io/resourceQuota` annotation. This can of course also be {xref-override-default-limit-in-namespaces}[done through the dashboard].

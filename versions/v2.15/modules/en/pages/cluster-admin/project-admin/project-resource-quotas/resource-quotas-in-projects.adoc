...
:page-community-path: how-to-guides/advanced-user-guides/manage-projects/manage-project-resource-quotas/about-project-resource-quotas.adoc 
:page-product-path: cluster-admin/project-admin/project-resource-quotas/resource-quotas-in-projects.adoc
ifeval::["{build-type}" != "community"]
:xref-override-default-limit-in-namespaces: xref:cluster-admin/project-admin/project-resource-quotas/override-default-limit-in-namespaces.adoc
:xref-resource-quota-types: xref:cluster-admin/project-admin/project-resource-quotas/resource-quota-types.adoc
endif::[]
ifeval::["{build-type}" == "community"]
:xref-override-default-limit-in-namespaces: xref:how-to-guides/advanced-user-guides/manage-projects/manage-project-resource-quotas/override-default-limit-in-namespaces.adoc
...
requested quota limit, use the `field.cattle.io/resourceQuota` annotation. You can also configure these settings in the Rancher UI.
For more information see {xref-override-default-limit-in-namespaces}[override default limits in namespaces].
...
[#_field_cattle_io_resourcequota_annotation]
== `field.cattle.io/resourceQuota` annotation

The `field.cattle.io/resourceQuota` annotation is a JSON object containing a single key, `limit`. The value of `limit` is a JSON object with keys that map to {xref-resource-quota-types}[resource quota types].

All key values are strings, except for `extended`. The `extended` key contains a JSON object that maps arbitrary resource references to string values.

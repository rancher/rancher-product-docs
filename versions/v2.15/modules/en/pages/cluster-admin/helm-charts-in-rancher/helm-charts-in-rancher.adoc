...
Rancher adds the `refreshInterval` field to the `ClusterRepo` custom resource definition (CRD). By default, Rancher syncs each Helm repository every hour (3600 seconds).

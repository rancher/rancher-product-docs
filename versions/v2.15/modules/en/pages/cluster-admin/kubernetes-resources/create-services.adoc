...
:page-community-path: how-to-guides/new-user-guides/kubernetes-resources-setup/create-services.adoc 
:page-product-path: cluster-admin/kubernetes-resources/create-services.adoc
:experimental:

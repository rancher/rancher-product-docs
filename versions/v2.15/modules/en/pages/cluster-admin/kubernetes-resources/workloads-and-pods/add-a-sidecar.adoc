...
:page-community-path: how-to-guides/new-user-guides/kubernetes-resources-setup/workloads-and-pods/add-a-sidecar.adoc 
:page-product-path: cluster-admin/kubernetes-resources/workloads-and-pods/add-a-sidecar.adoc
...
. Set the remaining options. You can read about them in {xref-deploy-workloads}[Deploying Workloads].
. Click *Launch*.

...
:page-community-path: how-to-guides/new-user-guides/kubernetes-resources-setup/kubernetes-and-docker-registries.adoc 
:page-product-path: cluster-admin/kubernetes-resources/kubernetes-and-docker-registries.adoc

...
After you upgrade to v1.25, add the necessary Rancher namespace exemptions. See xref:../psact.adoc#_exempting_required_rancher_namespaces[Pod Security Admission (PSA) Configuration Templates] for more details.
====

...
[NOTE]
====
If you intend to import an RKE cluster into Rancher, please consult the xref:../../psact.adoc[documentation] for how to configure the PSA to exempt Rancher system namespaces.
====

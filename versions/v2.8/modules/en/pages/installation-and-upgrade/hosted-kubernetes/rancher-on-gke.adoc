...
If you already have a GKE Kubernetes cluster, skip to the step about <<_7_install_an_ingress,installing an ingress.>> Then install the Rancher Helm chart following the instructions on xref:../install-rancher.adoc#_install_the_rancher_helm_chart[this page.]

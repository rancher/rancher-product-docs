...
For the instructions to upgrade Rancher installed with Docker, refer to xref:../getting-started/installation-and-upgrade/other-installation-methods/rancher-on-a-single-node-with-docker/upgrade-docker-installed-rancher.adoc[this page.]
...
Note that upgrades _to_ or _from_ any chart in the xref:../getting-started/installation-and-upgrade/resources/choose-a-rancher-version.adoc#_helm_chart_repositories[rancher-alpha repository] aren't supported.
...
If you are installing Rancher in an air-gapped environment, skip the rest of this page and render the Helm template by following the instructions on xref:other-installation-methods/air-gapped/upgrades.adoc[this page.]
====

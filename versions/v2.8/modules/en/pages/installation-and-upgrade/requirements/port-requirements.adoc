...
Refer to the link:../../integrations/harvester/overview.adoc#port-requirements[Harvester Integration Overview] for more information on Harvester port requirements.

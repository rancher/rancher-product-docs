...
Alternatively, it is also possible to set up Rancher completely air-gapped without any Internet access. This process is described in detail in the xref:../air-gapped/air-gapped.adoc[Rancher docs].

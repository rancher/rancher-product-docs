...
If you want terminate SSL/TLS externally, see xref:../../references/helm-chart-options.adoc#_external_tls_termination[TLS termination on an External Load Balancer].
====

...
For an example of one way to set up Linux nodes, refer to this xref:[tutorial] for setting up nodes as instances in Amazon EC2.
...
== xref:installation-and-upgrade/other-installation-methods/air-gapped/publish-images.adoc[Next: Collect and Publish Images to your Private Registry]

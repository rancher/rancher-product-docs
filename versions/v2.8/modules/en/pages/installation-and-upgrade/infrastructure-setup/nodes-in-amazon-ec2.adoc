...
* *Create security group:* We also recommend setting up a security group for the Rancher nodes that complies with the link:../requirements/requirements.adoc#port-requirements[port requirements for Rancher nodes.]
...
. In *Step 6: Configure Security Group,* select a security group that complies with the link:../requirements/requirements.adoc#port-requirements[port requirements] for Rancher nodes.

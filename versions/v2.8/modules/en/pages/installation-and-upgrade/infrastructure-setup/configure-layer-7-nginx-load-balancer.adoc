...
Make sure that your node fulfills the general xref:../requirements/requirements.adoc[installation requirements.]

== Installation Outline

== 1. Provision Linux Host

Provision a single Linux host according to our xref:../requirements/requirements.adoc[Requirements] to launch your Rancher Server.
...
This operation requires xref:../../getting-started/installation-and-upgrade/other-installation-methods/rancher-on-a-single-node-with-docker/rancher-on-a-single-node-with-docker.adoc#_privileged_access_for_rancher[privileged access].

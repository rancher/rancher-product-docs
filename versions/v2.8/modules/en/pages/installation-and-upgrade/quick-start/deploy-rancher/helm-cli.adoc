...
The full installation requirements are xref:../../requirements/requirements.adoc[here].
...
See xref:../../resources/bootstrap-password.adoc#_password_requirements[Setting up the Bootstrap Password] for password requirments.
...
These instructions also left out the full installation requirements and other installation options. If you have any issues with these steps, refer to the full xref:../../install-rancher.adoc[Helm CLI installation docs.]

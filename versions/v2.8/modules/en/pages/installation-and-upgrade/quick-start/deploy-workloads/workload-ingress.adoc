...
* xref:../../../getting-started/quick-start-guides/deploy-rancher-manager/aws.adoc#_destroying_the_environment[Amazon AWS: Destroying the Environment]
* xref:../../../getting-started/quick-start-guides/deploy-rancher-manager/digitalocean.adoc#_destroying_the_environment[DigitalOcean: Destroying the Environment]
* xref:../../../getting-started/quick-start-guides/deploy-rancher-manager/linode.adoc#_destroying_the_environment[Linode: Destroying the Environment]
* xref:../../../getting-started/quick-start-guides/deploy-rancher-manager/vagrant.adoc#_destroying_the_environment[Vagrant: Destroying the Environment]

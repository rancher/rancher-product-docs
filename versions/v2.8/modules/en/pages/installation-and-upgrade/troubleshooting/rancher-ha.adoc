...
Alternatively, in order to make such changes permanent, these environment variables can be set by xref:../references/helm-chart-options.adoc#_setting_extra_environment_variables[using Helm values] instead.

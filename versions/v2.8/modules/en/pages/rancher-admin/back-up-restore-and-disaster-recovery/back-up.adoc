...
. For configuring the Backup details using the form, click *Create* and refer to the xref:rancher-admin/back-up-restore-and-disaster-recovery/configuration/backup.adoc[configuration reference] and to the link:configuration/examples.adoc#backup[examples.]
...
+
For help configuring the Backup, refer to the xref:rancher-admin/back-up-restore-and-disaster-recovery/configuration/backup.adoc[configuration reference] and to the link:configuration/examples.adoc#backup[examples.]
+

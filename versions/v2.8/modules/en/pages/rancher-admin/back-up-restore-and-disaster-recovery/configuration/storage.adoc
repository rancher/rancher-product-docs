...
| Credential Secret
| Choose the credentials for S3 from your secrets in Rancher. link:backup.adoc#example-credentialsecret[Example].
...
Select an existing Persistent Volume (PV) that will be used to store your backups. For information about creating PersistentVolumes in Rancher, refer to link:../../../cluster-admin/manage-clusters/persistent-storage/set-up-existing-storage.adoc#2-add-a-persistentvolume-that-refers-to-the-persistent-storage[this section.]

...
You can link:apply-templates.adoc#creating-a-cluster-from-an-rke-template[create a cluster from a template] that you created, or from a template that has been xref:rancher-admin/global-configuration/rke1-templates/access-or-share-templates.adoc[shared with you.]

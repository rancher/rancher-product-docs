...
Within Rancher, each person authenticates as a _user_, which is a login that grants you access to Rancher. As mentioned in xref:../authn-and-authz.adoc[Authentication], users can either be local or external.

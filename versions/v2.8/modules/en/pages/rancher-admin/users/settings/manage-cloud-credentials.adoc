...
When you create a cluster xref:../../../cluster-deployment/infra-providers/infra-providers.adoc[hosted by an infrastructure provider], link:../../../cluster-deployment/infra-providers/infra-providers.adoc#node-templates[node templates] are used to provision the cluster nodes. These templates use Docker Machine configuration options to define an operating system image and settings/parameters for the node.
...
* link:../../../cluster-deployment/infra-providers/infra-providers.adoc#node-templates[During creation of a node template] for a cluster.
...
. Click *Create*.
. Click a cloud credential type. The values of this dropdown is based on the `active` xref:../../global-configuration/provisioning-drivers/manage-node-drivers.adoc[node drivers] in Rancher.
...
*Result:* The cloud credential is created and can immediately be used to link:../../../cluster-deployment/infra-providers/infra-providers.adoc#node-templates[create node templates].

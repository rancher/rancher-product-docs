...
. Configure the options for how pods are deleted. For more information about each option, refer to xref:../manage-clusters/nodes-and-node-pools.adoc#_aggressive_and_safe_draining_options[this section.]

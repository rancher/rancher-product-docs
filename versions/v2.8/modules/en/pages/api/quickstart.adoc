...
. link:../rancher-admin/users/settings/api-keys.adoc#creating-an-api-key[Create] a Rancher API key with no scope.
...
In this example, we'll show how to use kubectl to create a project, followed by deleting it. For a list of other Rancher resources available, refer to the link:./reference.adoc[API Reference] page.

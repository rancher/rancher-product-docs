...
. <<_rke_2_create_a_node_template_with_your_cloud_credentials_and_information_from_ec2,Create a node template with your cloud credentials and information from EC2>>
...
[#_rke_2_create_a_node_template_with_your_cloud_credentials_and_information_from_ec2]
[pass]
<h3><a class="anchor" id="_rke_2_create_a_node_template_with_your_cloud_credentials_and_information_from_ec2" href="#_rke_2_create_a_node_template_with_your_cloud_credentials_and_information_from_ec2"></a>2. Create a node template with your cloud credentials and information from EC2</h3>

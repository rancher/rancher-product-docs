...
For details on configuring RKE Kubernetes clusters in Rancher, refer to the xref:../../configuration/rke1.adoc#_rke_cluster_config_file_reference[cluster configuration reference.]
...
Creating a xref:../infra-providers.adoc#_node_templates[node template] for vSphere will allow Rancher to provision new nodes in vSphere. Node templates can be reused for other clusters.

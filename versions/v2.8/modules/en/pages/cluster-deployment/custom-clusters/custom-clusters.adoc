...
See xref:windows/use-windows-clusters.adoc[Configuring Custom Clusters for Windows] before you start.
====
...
Provision the host according to the xref:../node-requirements.adoc[installation requirements] and the xref:../production-checklist/production-checklist.adoc[checklist for production-ready clusters.]
 ...
 ** See xref:windows/use-windows-clusters.adoc[Enable the Windows Support Option].

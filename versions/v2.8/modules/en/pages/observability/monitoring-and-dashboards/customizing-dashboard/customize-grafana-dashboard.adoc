...
To see the links to the external monitoring UIs, including Grafana dashboards, you will need at least a link:../rbac-for-monitoring.adoc#users-with-rancher-based-permissions[project-member role.]

...
This section assumes familiarity with how monitoring components work together. For more information about Alertmanager, see xref:../../how-monitoring-works.adoc#_3_how_alertmanager_works[this section.]
====

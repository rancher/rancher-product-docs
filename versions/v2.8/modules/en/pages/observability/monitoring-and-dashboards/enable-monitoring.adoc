...
* Make sure that your cluster fulfills the resource requirements. The cluster should have at least 1950Mi memory available, 2700m CPU, and 50Gi storage. See xref:configuration/helm-chart-options.adoc#_configuring_resource_limits_and_requests[Configuring Resource Limits and Requests] for a breakdown of the resource limits and requests.
...
For more information about the default limits, see xref:configuration/helm-chart-options.adoc#_configuring_resource_limits_and_requests[this page.]

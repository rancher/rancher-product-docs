...
For more information, refer to the logging documentation xref:logging/logging.adoc[here.]
...
For more information, refer to the monitoring documentation xref:monitoring-and-dashboards/monitoring-and-alerting.adoc[here.]
...
For more information, refer to the Istio documentation xref:istio/istio.adoc[here.]

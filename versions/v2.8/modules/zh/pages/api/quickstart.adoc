...
. link:../rancher-admin/users/settings/api-keys.adoc#创建-api-密钥[创建]一个没有作用域的 Rancher API 密钥。
...
在此示例中，我们将展示如何使用 kubectl 创建一个项目，然后删除它。关于其他可用的 Rancher 资源列表，请参阅 link:./reference.adoc[API 参考]。

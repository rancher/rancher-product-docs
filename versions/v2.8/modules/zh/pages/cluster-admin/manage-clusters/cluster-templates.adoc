...
* Fleet 仓库必须遵循此处的link:https://documentation.suse.com/cloudnative/continuous-delivery/{fleet-docs-version}/en/explanations/gitrepo-content.html[指南]。对于 RKE2 集群模板，则必须把 `fleet.yaml` 文件添加到仓库。
====

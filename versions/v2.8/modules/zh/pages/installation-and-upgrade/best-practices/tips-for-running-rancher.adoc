...
如果你在 vSphere 环境中安装 Rancher，请参见xref:rancher-on-vsphere.adoc[最佳实践文档]。
...
Rancher Server 的 Kubernetes 集群应该尽可能满足xref:../requirements/requirements.adoc[系统和硬件要求]。越偏离系统和硬件要求，你可能面临的风险就越大。

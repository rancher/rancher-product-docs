...
如果你想检查证书是否正确，请查看link:../faq/technical-items.adoc#如何在服务器证书中检查-common-name-和-subject-alternative-names[如何在服务器证书中检查 Common Name 和 Subject Alternative Names]。
====
...
如果遇到任何问题，请参见xref:troubleshooting.adoc[故障排除]。

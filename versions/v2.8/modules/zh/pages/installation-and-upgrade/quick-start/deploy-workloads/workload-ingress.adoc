...
* xref:../../../getting-started/quick-start-guides/deploy-rancher-manager/aws.adoc#_销毁环境[Amazon AWS：销毁环境]
* xref:../../../getting-started/quick-start-guides/deploy-rancher-manager/digitalocean.adoc#_销毁环境[DigitalOcean：销毁环境]
* xref:../../../getting-started/quick-start-guides/deploy-rancher-manager/vagrant.adoc#_销毁环境[Vagrant：销毁环境]

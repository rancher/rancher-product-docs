...
有关在 Rancher 中配置 RKE Kubernetes 集群的详细信息，请参阅link:../../configuration/rke1.adoc#rke-集群配置文件参考[集群配置参考]。
...
为 vSphere 创建link:../infra-providers.adoc#节点模板[节点模板]会允许 Rancher 在 vSphere 中配置新节点。其他集群可以复用节点模板。

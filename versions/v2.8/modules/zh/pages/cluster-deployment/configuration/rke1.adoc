...
授权集群端点仅适用于 Rancher 启动的 Kubernetes 集群，即只适用于 Rancher link:../../about-rancher/architecture/communicating-with-downstream-clusters.adoc#配置-kubernetes-集群的工具[使用 RKE] 来配置的集群。它不适用于托管在 Kubernetes 提供商中的集群，例如 Amazon 的 EKS。
====

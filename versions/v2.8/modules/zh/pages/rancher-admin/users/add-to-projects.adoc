...
如果你需要为用户提供对集群内 _所有_ 项目的访问权限，请参见xref:authn-and-authz/manage-role-based-access-control-rbac/cluster-and-project-roles.adoc[添加集群成员]。
====
...
. 分配用户或组的**项目**角色。
+
xref:authn-and-authz/manage-role-based-access-control-rbac/cluster-and-project-roles.adoc[什么是项目角色？]
+
 ...
 ** 对于``自定义``角色，你可以修改可分配的角色列表。
  *** 要将角色添加到列表中，请xref:authn-and-authz/manage-role-based-access-control-rbac/custom-roles.adoc[添加自定义角色]。
  *** 要从列表中删除角色，请xref:authn-and-authz/manage-role-based-access-control-rbac/locked-roles.adoc[锁定/解锁角色]。

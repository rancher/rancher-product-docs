...
* xref:manage-cloud-credentials.adoc[云凭证]：管理xref:../../../cluster-deployment/infra-providers/infra-providers.adoc#_节点模板[节点模板]使用的云凭证，从而xref:../../../cluster-deployment/launch-kubernetes-with-rancher.adoc[为集群配置节点]。

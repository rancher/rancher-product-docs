...
* 分配了xref:../../users/authn-and-authz/manage-role-based-access-control-rbac/global-permissions.adoc[管理集群驱动角色]的xref:../../users/authn-and-authz/manage-role-based-access-control-rbac/global-permissions.adoc#_自定义全局权限[自定义全局权限]。
====

...
This section intended to help you set up an alternative method to access a xref:cluster-deployment/launch-kubernetes-with-rancher.adoc[Rancher-launched cluster].

...
:community-path: how-to-guides/new-user-guides/manage-clusters/create-kubernetes-persistent-storage/manage-persistent-storage/install-iscsi-volumes 
:product-path: cluster-admin/manage-clusters/persistent-storage/install-iscsi-volumes

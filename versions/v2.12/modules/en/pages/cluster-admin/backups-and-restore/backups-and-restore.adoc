...
:xref-rancher-restore: xref:cluster-admin/backups-and-restore/restore.adoc
endif::[]
ifeval::["{build-type}" == "community"]
...
:xref-rancher-restore: xref:how-to-guides/new-user-guides/backup-restore-and-disaster-recovery/restore-rancher-launched-kubernetes-clusters-from-backup.adoc
endif::[]
...
* {xref-rancher-restore}#_restoring_a_cluster_from_a_snapshot[Restoring a cluster from backup]

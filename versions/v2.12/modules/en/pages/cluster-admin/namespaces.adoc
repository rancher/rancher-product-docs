...
When working with project resources that you can assign to a namespace (i.e., xref:cluster-admin/kubernetes-resources/workloads-and-pods/deploy-workloads.adoc[workloads], {xref-http-encrypt}[certificates], {xref-configmaps}[ConfigMaps], etc.) you can create a namespace on the fly.
====

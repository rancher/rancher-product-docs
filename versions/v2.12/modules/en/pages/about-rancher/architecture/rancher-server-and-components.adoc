...
:community-path: reference-guides/rancher-manager-architecture/rancher-server-and-components 
:product-path: about-rancher/architecture/rancher-server-and-components

...
:community-path: how-to-guides/advanced-user-guides/enable-api-audit-log-in-downstream-clusters 
:product-path: observability/logging/enable-api-audit-log-in-downstream-clusters

...
:community-path: how-to-guides/advanced-user-guides/monitoring-alerting-guides/set-up-monitoring-for-workloads 
:product-path: observability/monitoring-and-dashboards/set-up-monitoring-for-workloads

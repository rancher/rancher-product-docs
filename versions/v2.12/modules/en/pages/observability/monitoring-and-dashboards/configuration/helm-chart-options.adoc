...
:community-path: reference-guides/monitoring-v2-configuration/helm-chart-options 
:product-path: observability/monitoring-and-dashboards/configuration/helm-chart-options
:experimental:

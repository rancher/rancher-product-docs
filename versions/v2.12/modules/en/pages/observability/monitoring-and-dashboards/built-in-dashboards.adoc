...
:community-path: integrations-in-rancher/monitoring-and-alerting/built-in-dashboards 
:product-path: observability/monitoring-and-dashboards/built-in-dashboards

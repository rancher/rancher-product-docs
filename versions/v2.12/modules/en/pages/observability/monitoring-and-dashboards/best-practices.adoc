...
:community-path: reference-guides/best-practices/rancher-managed-clusters/monitoring-best-practices 
:product-path: observability/monitoring-and-dashboards/best-practices

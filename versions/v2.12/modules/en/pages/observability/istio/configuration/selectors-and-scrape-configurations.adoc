...
:community-path: integrations-in-rancher/istio/configuration-options/selectors-and-scrape-configurations 
:product-path: observability/istio/configuration/selectors-and-scrape-configurations

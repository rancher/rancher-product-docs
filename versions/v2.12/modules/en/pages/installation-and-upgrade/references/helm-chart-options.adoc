...
:community-path: getting-started/installation-and-upgrade/installation-references/helm-chart-options 
:product-path: installation-and-upgrade/references/helm-chart-options

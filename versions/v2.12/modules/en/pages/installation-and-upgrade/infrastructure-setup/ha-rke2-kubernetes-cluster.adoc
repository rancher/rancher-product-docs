...
:community-path: how-to-guides/new-user-guides/infrastructure-setup/ha-rke2-kubernetes-cluster 
:product-path: installation-and-upgrade/infrastructure-setup/ha-rke2-kubernetes-cluster

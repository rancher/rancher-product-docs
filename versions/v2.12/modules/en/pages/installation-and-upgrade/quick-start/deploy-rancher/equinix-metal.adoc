...
:community-path: getting-started/quick-start-guides/deploy-rancher-manager/equinix-metal 
:product-path: installation-and-upgrade/quick-start/deploy-rancher/equinix-metal

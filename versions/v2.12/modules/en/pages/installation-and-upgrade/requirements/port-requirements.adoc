...
:community-path: getting-started/installation-and-upgrade/installation-requirements/port-requirements 
:product-path: installation-and-upgrade/requirements/port-requirements

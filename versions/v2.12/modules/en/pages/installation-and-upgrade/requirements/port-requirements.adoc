...
[%collapsible]
======
The following table depicts the port requirements for {xref-launch-k8s-with-rancher}[Rancher Launched Kubernetes] with xref:cluster-deployment/custom-clusters/custom-clusters.adoc[Custom Nodes].

...
You can add more arguments/binds/environment variables via the respective xref:cluster-deployment/configuration/rke2.adoc#_cluster_configuration[RKE2 Config File] or xref:cluster-deployment/configuration/k3s.adoc#_cluster_configuration[K3s Config File].

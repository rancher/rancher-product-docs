...
:community-path: how-to-guides/advanced-user-guides/compliance-scan-guides/uninstall-rancher-compliance 
:product-path: security/compliance-scans/uninstall-rancher-compliance
:experimental:

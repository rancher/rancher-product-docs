...
:community-path: how-to-guides/advanced-user-guides/compliance-scan-guides/run-a-scan-periodically-on-a-schedule 
:product-path: security/compliance-scans/run-a-scan-periodically-on-a-schedule
:experimental:

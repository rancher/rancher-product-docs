...
:community-path: how-to-guides/new-user-guides/authentication-permissions-and-global-configuration/about-rke1-templates/example-use-cases 
:product-path: rancher-admin/global-configuration/rke1-templates/example-use-cases

...
:community-path: how-to-guides/new-user-guides/authentication-permissions-and-global-configuration/configure-shibboleth-saml/about-group-permissions 
:product-path: rancher-admin/users/authn-and-authz/shibboleth-saml/group-permissions

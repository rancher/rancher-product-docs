...
:xref-rancher-extension-api-server: https://documentation.suse.com/cloudnative/rancher-manager/v2.12/en/api/extension-apiserver.html#_aggregation_layer_is_required 
endif::[]
ifeval::["{build-type}" == "community"]
:xref-rancher-extension-api-server: https://ranchermanager.docs.rancher.com/v2.12/api/extension-apiserver#aggregation-layer-is-required
endif::[]

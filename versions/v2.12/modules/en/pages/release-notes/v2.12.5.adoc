...
:xref-rancher-requirements: xref:getting-started/installation-and-upgrade/installation-requirements.adoc
endif::[]
ifeval::["{build-type}" == "community"]
...
ifeval::["{build-type}" == "community"]
If you're installing Rancher for the first time, your environment must fulfill the {xref-rancher-requirements}[installation requirements].
endif::[]
ifeval::["{build-type}" != "community"]
If you're installing Rancher for the first time, your environment must fulfill the {xref-rancher-requirements}[installation requirements].
endif::[]

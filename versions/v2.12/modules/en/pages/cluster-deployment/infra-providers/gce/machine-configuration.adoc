...
:community-path: reference-guides/cluster-configuration/downstream-cluster-configuration/machine-configuration/google-gce 
:product-path: cluster-deployment/infra-providers/gce/machine-configuration

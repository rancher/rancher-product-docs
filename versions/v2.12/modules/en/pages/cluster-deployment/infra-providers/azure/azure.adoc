...
For more information on configuring the Kubernetes cluster that Rancher installs on the Azure nodes, refer to the {xref-rke2-config}[RKE2] and xref:cluster-deployment/configuration/k3s.adoc[K3s] cluster configuration references.

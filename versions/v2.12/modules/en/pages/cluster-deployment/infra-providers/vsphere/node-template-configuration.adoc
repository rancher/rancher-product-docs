...
:community-path: reference-guides/cluster-configuration/downstream-cluster-configuration/node-template-configuration/vsphere 
:product-path: cluster-deployment/infra-providers/vsphere/node-template-configuration

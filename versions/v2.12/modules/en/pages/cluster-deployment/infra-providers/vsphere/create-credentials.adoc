...
:page-community-path: how-to-guides/new-user-guides/launch-kubernetes-with-rancher/use-new-nodes-in-an-infra-provider/vsphere/create-credentials.adoc 
:page-product-path: cluster-deployment/infra-providers/vsphere/create-credentials.adoc

...
:community-path: how-to-guides/new-user-guides/launch-kubernetes-with-rancher/use-new-nodes-in-an-infra-provider/vsphere/create-a-vm-template 
:product-path: cluster-deployment/infra-providers/vsphere/create-a-vm-template

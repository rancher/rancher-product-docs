...
:community-path: how-to-guides/new-user-guides/launch-kubernetes-with-rancher/use-new-nodes-in-an-infra-provider/nutanix/provision-kubernetes-clusters-in-aos 
:product-path: cluster-deployment/infra-providers/nutanix/provision-kubernetes-clusters-in-aos
:experimental:

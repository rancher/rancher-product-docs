...
:community-path: reference-guides/cluster-configuration/downstream-cluster-configuration/node-template-configuration/amazon-ec2 
:product-path: cluster-deployment/infra-providers/aws/node-template-configuration

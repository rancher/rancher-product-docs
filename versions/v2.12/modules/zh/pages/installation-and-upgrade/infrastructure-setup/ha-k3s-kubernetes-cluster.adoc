= 为高可用 {k3s-product-name} Kubernetes 集群设置基础设施
:revdate: 2025-08-05
...
有关每个安装选项的详情，请参见xref:installation-and-upgrade/installation-and-upgrade.adoc[本页]。
...
如需获取配置 MySQL 数据库示例，请参见xref:installation-and-upgrade/infrastructure-setup/mysql-database-in-amazon-rds.adoc[在 Amazon RDS 服务中配置 MySQL] 的教程。

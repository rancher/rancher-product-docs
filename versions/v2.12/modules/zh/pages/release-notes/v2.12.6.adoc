...
For additional details, see the Security Advisories and CVEs page in Rancher's xref:security/cve.adoc[documentation] or in Rancher's GitHub https://github.com/rancher/rancher/security/advisories[repository].

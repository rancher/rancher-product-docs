...
For additional details, see the Security Advisories and CVEs page in Rancher's https://ranchermanager.docs.rancher.com/{rn-component-version}/reference-guides/rancher-security/security-advisories-and-cves[documentation] or in Rancher's GitHub https://github.com/rancher/rancher/security/advisories[repository].

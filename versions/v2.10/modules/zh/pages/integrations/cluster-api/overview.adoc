...
请记住，如果使用此安装选项，你必须自行管理 CAPI Operator 的安装。你可以参照 Rancher Turtles 文档中的 https://documentation.suse.com/cloudnative/cluster-api/v0.17/en/operator/manual.html[CAPI Operator 指南]
====

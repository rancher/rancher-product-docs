...
所有 CNI 网络插件都支持link:https://docs.rke2.io/install/network_options#dual-stack-configuration[双栈]网络。要在双栈模式下配置 RKE2，请为你的<<_集群_cidr,集群 CIDR>> 和/或 <<_service_cidr,Service CIDR>> 设置有效的 IPv4/IPv6 CIDR。

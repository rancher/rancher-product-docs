...
:community-path: troubleshooting/other-troubleshooting-tips/expired-webhook-certificate-rotation 
:product-path: security/rancher-webhook/expired-webhook-certificate-rotation

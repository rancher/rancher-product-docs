...
:community-path: integrations-in-rancher/logging/custom-resource-configuration/flows-and-clusterflows 
:product-path: observability/logging/custom-resource-configuration/flows-and-clusterflows

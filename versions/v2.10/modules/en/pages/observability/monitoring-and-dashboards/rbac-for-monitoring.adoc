...
:community-path: integrations-in-rancher/monitoring-and-alerting/rbac-for-monitoring 
:product-path: observability/monitoring-and-dashboards/rbac-for-monitoring

...
:community-path: integrations-in-rancher/monitoring-and-alerting/promql-expressions 
:product-path: observability/monitoring-and-dashboards/promql-expressions

...
* The options below are available for {xref-launch-k8s-with-rancher}[Rancher-launched Kubernetes clusters] and xref:cluster-deployment/register-existing-clusters.adoc#_additional_features_for_registered_rke2_and_k3s_clusters[Registered K3s Kubernetes clusters].

...
If you need to update immediately, you can xref:{xref-helm-charts-in-rancher}#_refresh_chart_repositories[perform a manual refresh].
...
* Apps installed through OCI-based Helm chart repositories are subject to a known issue with how Rancher displays upgradeable version information. See the xref:{xref-helm-charts-in-rancher}#_limitations[Limitations] section of *Helm Charts and Apps* for more details.

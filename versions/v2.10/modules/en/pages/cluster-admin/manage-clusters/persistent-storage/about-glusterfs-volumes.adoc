...
:community-path: how-to-guides/new-user-guides/manage-clusters/create-kubernetes-persistent-storage/manage-persistent-storage/about-glusterfs-volumes 
:product-path: cluster-admin/manage-clusters/persistent-storage/about-glusterfs-volumes

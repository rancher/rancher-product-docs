...
:community-path: how-to-guides/new-user-guides/kubernetes-resources-setup/create-services 
:product-path: cluster-admin/kubernetes-resources/create-services
:experimental:

...
:community-path: reference-guides/best-practices/rancher-server/on-premises-rancher-in-vsphere 
:product-path: installation-and-upgrade/best-practices/rancher-on-vsphere

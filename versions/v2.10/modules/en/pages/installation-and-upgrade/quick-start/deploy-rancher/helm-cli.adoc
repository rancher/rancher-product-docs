...
:community-path: getting-started/quick-start-guides/deploy-rancher-manager/helm-cli 
:product-path: installation-and-upgrade/quick-start/deploy-rancher/helm-cli

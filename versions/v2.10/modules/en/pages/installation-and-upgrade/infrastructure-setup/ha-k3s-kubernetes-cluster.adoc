...
:community-path: how-to-guides/new-user-guides/infrastructure-setup/ha-k3s-kubernetes-cluster 
:product-path: installation-and-upgrade/infrastructure-setup/ha-k3s-kubernetes-cluster

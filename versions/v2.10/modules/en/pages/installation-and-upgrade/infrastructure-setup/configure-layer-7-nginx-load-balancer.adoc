...
:community-path: how-to-guides/advanced-user-guides/configure-layer-7-nginx-load-balancer 
:product-path: installation-and-upgrade/infrastructure-setup/configure-layer-7-nginx-load-balancer

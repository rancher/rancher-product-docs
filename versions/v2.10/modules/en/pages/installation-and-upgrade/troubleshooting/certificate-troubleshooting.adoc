...
:community-path: getting-started/installation-and-upgrade/other-installation-methods/rancher-on-a-single-node-with-docker/certificate-troubleshooting 
:product-path: installation-and-upgrade/troubleshooting/certificate-troubleshooting

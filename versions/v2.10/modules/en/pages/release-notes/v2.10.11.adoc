...
If you're installing Rancher for the first time, your environment must fulfill the https://ranchermanager.docs.rancher.com/v2.10/getting-started/installation-and-upgrade/installation-requirements[installation requirements].
endif::[]
ifeval::["{build-type}" != "community"]
...
ifeval::["{build-type}" != "community"]
Rancher now supports the ability to use an OCI Helm chart registry for Apps & Marketplace. View documentation on xref:cluster-admin/helm-charts-in-rancher/oci-repositories.adoc[using OCI based Helm chart repositories] and note this feature is in an experimental stage. See https://github.com/rancher/rancher/issues/29105[#29105] and https://github.com/rancher/rancher/pull/45062[#45062].
endif::[]
ifeval::["{build-type}" == "community"]
Rancher now supports the ability to use an OCI Helm chart registry for Apps & Marketplace. View documentation on https://ranchermanager.docs.rancher.com/v2.10/how-to-guides/new-user-guides/helm-charts-in-rancher/oci-repositories[using OCI based Helm chart repositories] and note this feature is in an experimental stage. See https://github.com/rancher/rancher/issues/29105[#29105] and https://github.com/rancher/rancher/pull/45062[#45062].
endif::[]

...
:community-path: how-to-guides/new-user-guides/launch-kubernetes-with-rancher/use-new-nodes-in-an-infra-provider/create-an-azure-cluster 
:product-path: cluster-deployment/infra-providers/azure/azure

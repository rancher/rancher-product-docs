...
:community-path: reference-guides/best-practices/rancher-managed-clusters/rancher-managed-clusters-in-vsphere 
:product-path: cluster-deployment/infra-providers/vsphere/best-practices

...
* xref:./aws.adoc#_example_iam_policy_with_passrole[Example IAM Policy with PassRole] (needed if you want to use {xref-set-up-cloud-providers}[Kubernetes Cloud Provider] or want to pass an IAM Profile to an instance)

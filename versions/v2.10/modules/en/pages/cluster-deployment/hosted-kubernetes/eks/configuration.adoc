...
:community-path: reference-guides/cluster-configuration/rancher-server-configuration/eks-cluster-configuration 
:product-path: cluster-deployment/hosted-kubernetes/eks/configuration

...
:community-path: reference-guides/backup-restore-configuration/storage-configuration 
:product-path: rancher-admin/back-up-restore-and-disaster-recovery/configuration/storage

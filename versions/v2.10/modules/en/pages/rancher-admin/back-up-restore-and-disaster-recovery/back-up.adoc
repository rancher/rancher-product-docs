...
. For configuring the Backup details using the form, click *Create* and refer to the {xref-rancher-backup-config}[configuration reference] and to the xref:./configuration/examples.adoc#_backup[examples.]
...
+
For help configuring the Backup, refer to the {xref-rancher-backup-config}[configuration reference] and to the xref:./configuration/examples.adoc#_backup[examples.]
+

...
:community-path: troubleshooting/kubernetes-components/troubleshooting-controlplane-nodes 
:product-path: troubleshooting/kubernetes-components/troubleshooting-controlplane-nodes

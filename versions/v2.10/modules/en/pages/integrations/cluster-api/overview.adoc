...
For detailed information on the values supported by the chart and their usage, refer to https://documentation.suse.com/cloudnative/cluster-api/v0.17/en/operator/chart.html[Helm chart options].
====
...
Remember that if you opt for this installation option, you must manage the CAPI Operator installation yourself. You can follow the https://documentation.suse.com/cloudnative/cluster-api/v0.17/en/operator/manual.html[manual installation guide] in the Cluster API documentation for assistance.
====

...
:url-cluster-api-operator-values: https://documentation.suse.com/cloudnative/cluster-api/v0.24/en/operator/chart.html#_cluster_api_operator_values
...
:url-cluster-api-operator-values: https://turtles.docs.rancher.com/turtles/v0.24/en/operator/chart.html#_cluster_api_operator_values

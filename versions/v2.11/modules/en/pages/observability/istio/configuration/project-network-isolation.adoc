...
:community-path: integrations-in-rancher/istio/configuration-options/project-network-isolation 
:product-path: observability/istio/configuration/project-network-isolation

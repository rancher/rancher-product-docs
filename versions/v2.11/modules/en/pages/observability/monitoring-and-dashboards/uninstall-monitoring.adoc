...
:community-path: how-to-guides/advanced-user-guides/monitoring-alerting-guides/uninstall-monitoring 
:product-path: observability/monitoring-and-dashboards/uninstall-monitoring

...
:community-path: how-to-guides/advanced-user-guides/monitoring-alerting-guides/debug-high-memory-usage 
:product-path: observability/monitoring-and-dashboards/configuration/debug-high-memory-usage

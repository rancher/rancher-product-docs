...
:community-path: troubleshooting/kubernetes-components/troubleshooting-etcd-nodes 
:product-path: troubleshooting/kubernetes-components/troubleshooting-etcd-nodes

...
:community-path: troubleshooting/other-troubleshooting-tips/kubernetes-resources 
:product-path: troubleshooting/other-troubleshooting-tips/kubernetes-resources

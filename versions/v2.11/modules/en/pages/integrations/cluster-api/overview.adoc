...
:page-community-path: integrations-in-rancher/cluster-api/overview.adoc 
:page-product-path: integrations/cluster-api/overview.adoc
:experimental:
ifeval::["{build-type}" != "community"]
:url-capi-slsa: https://documentation.suse.com/cloudnative/cluster-api/{turtles-docs-version}/en/security/slsa.html
:url-capi-chart: https://documentation.suse.com/cloudnative/cluster-api/{turtles-docs-version}/en/operator/chart.html
:url-capi-manual: https://documentation.suse.com/cloudnative/cluster-api/{turtles-docs-version}/en/operator/manual.html
endif::[]
ifeval::["{build-type}" == "community"]
:url-capi-slsa: https://turtles.docs.rancher.com/turtles/{turtles-docs-version}/en/security/slsa.html
:url-capi-chart: https://turtles.docs.rancher.com/turtles/{turtles-docs-version}/en/operator/chart.html
:url-capi-manual: https://turtles.docs.rancher.com/turtles/{turtles-docs-version}/en/operator/manual.html
endif::[]
...
The CAPI Operator allows for handling the lifecycle of {url-capi-manual}[CAPI providers] using a declarative approach, extending the capabilities of `clusterctl`. If you want to learn more about it, you can refer to https://cluster-api-operator.sigs.k8s.io/[Cluster API Operator book].
...
For detailed information on the values supported by the chart and their usage, refer to {url-capi-chart}[Helm chart options].
====
...
Remember that if you opt for this installation option, you must manage the CAPI Operator installation yourself. You can follow the {url-capi-manual}[manual installation guide] in the Cluster API documentation for assistance.
====

...
:community-path: how-to-guides/new-user-guides/kubernetes-resources-setup/kubernetes-and-docker-registries 
:product-path: cluster-admin/kubernetes-resources/kubernetes-and-docker-registries

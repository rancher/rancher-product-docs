...
:community-path: how-to-guides/new-user-guides/manage-clusters/projects-and-namespaces 
:product-path: cluster-admin/manage-clusters/projects-and-namespaces

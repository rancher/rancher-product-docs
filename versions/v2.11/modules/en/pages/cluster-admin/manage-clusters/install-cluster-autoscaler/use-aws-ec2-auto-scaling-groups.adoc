...
:page-community-path: how-to-guides/new-user-guides/manage-clusters/install-cluster-autoscaler/use-aws-ec2-auto-scaling-groups.adoc 
:page-product-path: cluster-admin/manage-clusters/install-cluster-autoscaler/use-aws-ec2-auto-scaling-groups.adoc
 ...
 ** Security group: `K8sMasterSg` More info at {xref-port-reqs}#_downstream_kubernetes_cluster_nodes[RKE ports (custom nodes tab)]
 ** Tags:
...
* Security group: `K8sWorkerSg` More info at {xref-port-reqs}#_downstream_kubernetes_cluster_nodes[RKE ports (custom nodes tab)]
* Tags:
 ** `kubernetes.io/cluster/<clusterID>: owned`
...
More info is at {xref-cloud-provider-amazon}[RKE clusters on AWS] and https://github.com/kubernetes/autoscaler/blob/master/cluster-autoscaler/cloudprovider/aws/README.md[Cluster Autoscaler on AWS.]

...
:page-community-path: how-to-guides/new-user-guides/manage-clusters/install-cluster-autoscaler/index.adoc 
:page-product-path: cluster-admin/manage-clusters/install-cluster-autoscaler/install-cluster-autoscaler.adoc
ifeval::["{build-type}" != "community"]
:xref-use-aws-ec2-autoscaling-group: xref:cluster-admin/manage-clusters/install-cluster-autoscaler/use-aws-ec2-auto-scaling-groups.adoc
endif::[]
ifeval::["{build-type}" == "community"]
:xref-use-aws-ec2-autoscaling-group: xref:how-to-guides/new-user-guides/manage-clusters/install-cluster-autoscaler/use-aws-ec2-auto-scaling-groups.adoc
endif::[]
...
For details on running the cluster autoscaler  on Amazon cloud provider, refer to {xref-use-aws-ec2-autoscaling-group}[this page.]

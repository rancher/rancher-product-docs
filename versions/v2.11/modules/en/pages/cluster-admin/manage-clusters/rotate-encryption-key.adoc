...
:page-community-path: how-to-guides/new-user-guides/manage-clusters/rotate-encryption-key.adoc 
:page-product-path: cluster-admin/manage-clusters/rotate-encryption-key.adoc
:experimental:

...
:page-community-path: how-to-guides/new-user-guides/manage-clusters/nodes-and-node-pools.adoc 
:page-product-path: cluster-admin/manage-clusters/nodes-and-node-pools.adoc

...
:page-community-path: how-to-guides/new-user-guides/manage-clusters/rotate-certificates.adoc 
:page-product-path: cluster-admin/manage-clusters/rotate-certificates.adoc

...
:community-path: how-to-guides/advanced-user-guides/manage-projects/manage-project-resource-quotas/about-project-resource-quotas 
:product-path: cluster-admin/project-admin/project-resource-quotas/resource-quotas-in-projects

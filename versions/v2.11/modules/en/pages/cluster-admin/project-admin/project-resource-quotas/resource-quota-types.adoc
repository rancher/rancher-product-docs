...
:community-path: how-to-guides/advanced-user-guides/manage-projects/manage-project-resource-quotas/resource-quota-types 
:product-path: cluster-admin/project-admin/project-resource-quotas/resource-quota-types

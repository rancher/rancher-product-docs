...
:page-community-path: reference-guides/rancher-security/kubernetes-security-best-practices.adoc 
:page-product-path: security/kubernetes-security-best-practices.adoc

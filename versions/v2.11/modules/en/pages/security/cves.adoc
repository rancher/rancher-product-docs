...
| Rancher now provides new versions of the Rancher Backup chart which prevent the leak of secret S3 credentials via the Rancher Backup pod log. For more information.
| 29 Jan 2026
| Rancher https://documentation.suse.com/cloudnative/rancher-manager/v2.13/en/release-notes/v2.13.2.html[v2.13.2], https://documentation.suse.com/cloudnative/rancher-manager/v2.12/en/release-notes/v2.12.6.html[v2.12.6], https://documentation.suse.com/cloudnative/rancher-manager/v2.11/en/release-notes/v2.11.10.html[v2.11.10], and  https://github.com/rancher/rancher/releases/tag/vhttps://documentation.suse.com/cloudnative/rancher-manager/v2.10/en/release-notes/v2.10.11.html[v2.10.11]

| https://github.com/rancher/rancher/security/advisories/GHSA-mc24-7m59-4q5p[CVE-2025-67601]
| Rancher now removes the ability to fetch CA certificates stored in Rancher’s setting `cacerts` when using the `login` command. For more information.
| 29 Jan 2026
| Rancher https://documentation.suse.com/cloudnative/rancher-manager/v2.13/en/release-notes/v2.13.2.html[v2.13.2], https://documentation.suse.com/cloudnative/rancher-manager/v2.12/en/release-notes/v2.12.6.html[v2.12.6], https://documentation.suse.com/cloudnative/rancher-manager/v2.11/en/release-notes/v2.11.10.html[v2.11.10], and  https://github.com/rancher/rancher/releases/tag/vhttps://documentation.suse.com/cloudnative/rancher-manager/v2.10/en/release-notes/v2.10.11.html[v2.10.11]

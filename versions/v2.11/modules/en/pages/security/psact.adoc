...
:page-community-path: how-to-guides/new-user-guides/authentication-permissions-and-global-configuration/psa-config-templates.adoc 
:page-product-path: security/psact.adoc
...
If you select the *rancher-restricted* template but don't select a *CIS Profile*, you won't meet required CIS benchmarks. See the {xref-rke2-hardening-guide}[RKE2 hardening guide] for more details.
--

...
:page-community-path: integrations-in-rancher/cis-scans/index.adoc 
:page-product-path: security/cis-scans/cis-scans.adoc
ifeval::["{build-type}" != "community"]
:xref-security-overview: xref:security/security-overview.adoc
:xref-cis-howto: xref:security/cis-scans/how-to.adoc
:xref-cis-config: xref:security/cis-scans/configuration-reference.adoc
:xref-cis-scan-skip-tests: xref:security/cis-scans/skip-tests.adoc
:xref-cis-scan-rbac: xref:security/cis-scans/rbac-for-cis-scans.adoc
endif::[]
ifeval::["{build-type}" == "community"]
...
:xref-cis-config: xref:integrations-in-rancher/cis-scans/configuration-reference.adoc
:xref-cis-scan-skip-tests: xref:how-to-guides/advanced-user-guides/cis-scan-guides/skip-tests.adoc
:xref-cis-scan-rbac: xref:integrations-in-rancher/cis-scans/rbac-for-cis-scans.adoc
endif::[]
...
Some tests are designated as "Not Applicable." These tests will not be run on any CIS scan because of the way that Rancher provisions RKE clusters. For information on how test results can be audited, and why some tests are designated to be not applicable, refer to Rancher's {xref-security-overview}#_the_cis_benchmark_and_self_assessment[self-assessment guide] for the corresponding Kubernetes version.
...
For a list of skipped and not applicable tests, refer to {xref-cis-scan-skip-tests}[this page].
...
For information about permissions, refer to {xref-cis-scan-rbac}[this page]

== Configuration

For more information about configuring the custom resources for the scans, profiles, and benchmark versions, refer to {xref-cis-config}[this page]

== How-to Guides

Please refer to the {xref-cis-howto}[CIS Scan Guides] to learn how to run CIS scans.

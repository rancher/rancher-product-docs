...
:page-community-path: how-to-guides/advanced-user-guides/cis-scan-guides/uninstall-rancher-cis-benchmark.adoc 
:page-product-path: security/cis-scans/uninstall-rancher-cis-benchmark.adoc
:experimental:

...
:community-path: how-to-guides/advanced-user-guides/cis-scan-guides/configure-alerts-for-periodic-scan-on-a-schedule 
:product-path: security/cis-scans/configure-alerts-for-periodic-scan-on-a-schedule
:experimental:

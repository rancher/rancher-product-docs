...
:page-community-path: how-to-guides/advanced-user-guides/cis-scan-guides/skip-tests.adoc 
:page-product-path: security/cis-scans/skip-tests.adoc
:experimental:
ifeval::["{build-type}" != "community"]
:xref-cis-run-scan: xref:security/cis-scans/run-a-scan.adoc
endif::[]
ifeval::["{build-type}" == "community"]
:xref-cis-run-scan: xref:how-to-guides/advanced-user-guides/cis-scan-guides/run-a-scan.adoc
endif::[]
...
When you {xref-cis-run-scan}[run a scan] that uses this profile, the defined tests will be skipped during the scan. The skipped tests will be marked in the generated report as `Skip`.

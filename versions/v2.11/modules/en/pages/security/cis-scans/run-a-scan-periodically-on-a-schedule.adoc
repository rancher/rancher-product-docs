...
:page-community-path: how-to-guides/advanced-user-guides/cis-scan-guides/run-a-scan-periodically-on-a-schedule.adoc 
:page-product-path: security/cis-scans/run-a-scan-periodically-on-a-schedule.adoc
:experimental:

...
:community-path: how-to-guides/advanced-user-guides/cis-scan-guides/install-rancher-cis-benchmark.adoc 
:product-path: security/cis-scans/install-rancher-cis-benchmark.adoc
:experimental:

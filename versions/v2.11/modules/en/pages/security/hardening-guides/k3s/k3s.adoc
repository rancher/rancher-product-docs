= {k3s-product-name} Hardening Guides
:page-languages: [en, zh]
:revdate: 2025-08-18
:page-revdate: {revdate}
:page-community-path: reference-guides/rancher-security/hardening-guides/k3s-hardening-guide/index.adoc 
:page-product-path: security/hardening-guides/k3s/k3s.adoc

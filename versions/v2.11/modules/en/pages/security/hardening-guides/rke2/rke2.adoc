= {rke2-product-name} Hardening Guides
:page-languages: [en, zh]
:revdate: 2025-03-12
:page-revdate: {revdate}
:page-community-path: reference-guides/rancher-security/hardening-guides/rke2-hardening-guide/index.adoc 
:page-product-path: security/hardening-guides/rke2/rke2.adoc

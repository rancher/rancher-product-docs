...
:page-community-path: reference-guides/rke1-template-example-yaml.adoc 
:page-product-path: rancher-admin/global-configuration/rke1-templates/template-example-yaml.adoc

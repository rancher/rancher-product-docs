...
:page-community-path: reference-guides/user-settings/manage-cloud-credentials.adoc 
:page-product-path: rancher-admin/users/settings/manage-cloud-credentials.adoc

...
:page-community-path: how-to-guides/new-user-guides/authentication-permissions-and-global-configuration/authentication-config/configure-freeipa.adoc 
:page-product-path: rancher-admin/users/authn-and-authz/configure-freeipa.adoc

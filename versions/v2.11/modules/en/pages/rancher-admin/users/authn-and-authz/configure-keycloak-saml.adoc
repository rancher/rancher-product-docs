...
:community-path: how-to-guides/new-user-guides/authentication-permissions-and-global-configuration/authentication-config/configure-keycloak-saml 
:product-path: rancher-admin/users/authn-and-authz/configure-keycloak-saml

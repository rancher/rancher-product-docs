...
:community-path: getting-started/installation-and-upgrade/resources/upgrade-cert-manager 
:product-path: installation-and-upgrade/resources/upgrade-cert-manager

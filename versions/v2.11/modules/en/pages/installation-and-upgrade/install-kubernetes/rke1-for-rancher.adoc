...
:page-community-path: how-to-guides/new-user-guides/kubernetes-cluster-setup/rke1-for-rancher.adoc 
:page-product-path: installation-and-upgrade/install-kubernetes/rke1-for-rancher.adoc
...
For systems without direct internet access, refer to {xref-air-gap}[Air Gap: Kubernetes install.]
...
For tuning your etcd cluster for larger Rancher installations, see the {xref-tuning-etcd-for-large-installs}[etcd settings guide].

For more information regarding Dockershim support, refer to {xref-dockershim}[this page]
====
...
=== {xref-install-rancher}[Next: Install Rancher]

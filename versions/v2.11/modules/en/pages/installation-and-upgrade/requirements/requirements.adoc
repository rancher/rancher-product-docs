...
:xref-dockershim: xref:installation-and-upgrade/requirements/dockershim.adoc
:xref-install-docker: xref:installation-and-upgrade/requirements/install-docker.adoc
endif::[]
ifeval::["{build-type}" == "community"]
...
:xref-dockershim: xref:getting-started/installation-and-upgrade/installation-requirements/dockershim.adoc
:xref-install-docker: xref:getting-started/installation-and-upgrade/installation-requirements/install-docker.adoc
endif::[]
...
For more information, see {xref-install-docker}[Installing Docker].
...
For more information on Dockershim support, refer to {xref-dockershim}[this page].

...
:page-community-path: getting-started/installation-and-upgrade/installation-requirements/dockershim.adoc 
:page-product-path: installation-and-upgrade/requirements/dockershim.adoc

...
:community-path: getting-started/installation-and-upgrade/installation-requirements/dockershim.adoc 
:product-path: installation-and-upgrade/requirements/dockershim.adoc

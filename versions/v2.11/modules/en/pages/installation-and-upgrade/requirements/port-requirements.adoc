...
[%collapsible]
======
The following table depicts the port requirements for {xref-launch-k8s-with-rancher}[Rancher Launched Kubernetes] with nodes created in an xref:cluster-deployment/infra-providers/infra-providers.adoc[Infrastructure Provider].
...
[%collapsible]
======
The following table depicts the port requirements for xref:cluster-deployment/register-existing-clusters.adoc[registered clusters].

...
:community-path: getting-started/installation-and-upgrade/resources/helm-version-requirements 
:product-path: installation-and-upgrade/requirements/helm-version-requirements

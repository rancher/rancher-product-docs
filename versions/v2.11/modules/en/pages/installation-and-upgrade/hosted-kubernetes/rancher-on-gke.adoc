...
:community-path: getting-started/installation-and-upgrade/install-upgrade-on-a-kubernetes-cluster/rancher-on-gke 
:product-path: installation-and-upgrade/hosted-kubernetes/rancher-on-gke

...
:community-path: getting-started/installation-and-upgrade/install-upgrade-on-a-kubernetes-cluster/rancher-on-amazon-eks 
:product-path: installation-and-upgrade/hosted-kubernetes/rancher-on-amazon-eks

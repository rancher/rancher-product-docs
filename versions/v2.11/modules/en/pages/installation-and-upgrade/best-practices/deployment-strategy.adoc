...
:community-path: reference-guides/best-practices/rancher-server/rancher-deployment-strategy 
:product-path: installation-and-upgrade/best-practices/deployment-strategy

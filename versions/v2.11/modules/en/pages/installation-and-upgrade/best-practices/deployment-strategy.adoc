...
:page-community-path: reference-guides/best-practices/rancher-server/rancher-deployment-strategy.adoc 
:page-product-path: installation-and-upgrade/best-practices/deployment-strategy.adoc

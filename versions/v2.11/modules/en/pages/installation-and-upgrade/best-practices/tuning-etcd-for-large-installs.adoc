...
:community-path: how-to-guides/advanced-user-guides/tune-etcd-for-large-installs 
:product-path: installation-and-upgrade/best-practices/tuning-etcd-for-large-installs

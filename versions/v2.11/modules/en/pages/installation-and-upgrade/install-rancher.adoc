...
* *RKE:* For the tutorial to install an RKE Kubernetes cluster, refer to xref:installation-and-upgrade/install-kubernetes/rke1-for-rancher.adoc[this page.] For help setting up the infrastructure for a high-availability RKE cluster, refer to {xref-ha-rke1}[this page.]

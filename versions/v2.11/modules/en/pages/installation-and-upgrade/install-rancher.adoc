...
:page-community-path: getting-started/installation-and-upgrade/install-upgrade-on-a-kubernetes-cluster/index.adoc 
:page-product-path: installation-and-upgrade/install-rancher.adoc
...
:xref-rke1-for-rancher: xref:installation-and-upgrade/install-kubernetes/rke1-for-rancher.adoc
endif::[]
ifeval::["{build-type}" == "community"]
...
:xref-rke1-for-rancher: xref:how-to-guides/new-user-guides/kubernetes-cluster-setup/rke1-for-rancher.adoc
endif::[]
...
* *RKE:* For the tutorial to install an RKE Kubernetes cluster, refer to {xref-rke1-for-rancher}[this page.] For help setting up the infrastructure for a high-availability RKE cluster, refer to {xref-ha-rke1}[this page.]
...
https://docs.apps.rancher.io/[SUSE Application Collection] provides a {rancher-product-name} compatible cert-manager chart, follow the instructions below for installation.

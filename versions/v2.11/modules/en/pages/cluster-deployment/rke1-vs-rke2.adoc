= Behavior Differences Between RKE1 and {rke2-product-name}
:page-languages: [en, zh]
:revdate: 2025-03-21
:page-revdate: {revdate}
:page-community-path: how-to-guides/new-user-guides/launch-kubernetes-with-rancher/rke1-vs-rke2-differences.adoc 
:page-product-path: cluster-deployment/rke1-vs-rke2.adoc

...
:page-community-path: reference-guides/cluster-configuration/rancher-server-configuration/use-existing-nodes/index.adoc 
:page-product-path: cluster-deployment/custom-clusters/custom-clusters.adoc

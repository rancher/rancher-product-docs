...
:page-community-path: integrations-in-rancher/monitoring-and-alerting/rbac-for-monitoring.adoc 
:page-product-path: observability/monitoring-and-dashboards/rbac-for-monitoring.adoc

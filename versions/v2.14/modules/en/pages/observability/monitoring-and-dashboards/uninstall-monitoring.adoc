...
:page-community-path: how-to-guides/advanced-user-guides/monitoring-alerting-guides/uninstall-monitoring.adoc 
:page-product-path: observability/monitoring-and-dashboards/uninstall-monitoring.adoc

...
:page-community-path: reference-guides/prometheus-federator/index.adoc 
:page-product-path: observability/monitoring-and-dashboards/prometheus-federator/prometheus-federator.adoc

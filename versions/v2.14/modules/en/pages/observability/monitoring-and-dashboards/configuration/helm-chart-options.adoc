...
:page-community-path: reference-guides/monitoring-v2-configuration/helm-chart-options.adoc 
:page-product-path: observability/monitoring-and-dashboards/configuration/helm-chart-options.adoc
:experimental:

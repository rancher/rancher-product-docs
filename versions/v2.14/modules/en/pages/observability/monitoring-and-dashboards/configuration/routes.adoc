...
:page-community-path: reference-guides/monitoring-v2-configuration/routes.adoc 
:page-product-path: observability/monitoring-and-dashboards/configuration/routes.adoc

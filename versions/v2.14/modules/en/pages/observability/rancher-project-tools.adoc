...
:page-community-path: reference-guides/rancher-project-tools.adoc 
:page-product-path: observability/rancher-project-tools.adoc
...
For details, refer to the {xref-logging}[logging section.]

[#_monitoring]
== Monitoring

Using Rancher, you can monitor the state and processes of your cluster nodes, Kubernetes components, and software deployments through integration with https://prometheus.io/[Prometheus], a leading open-source monitoring solution. For details, refer to the {xref-monitoring-and-dashboards}[monitoring section.]

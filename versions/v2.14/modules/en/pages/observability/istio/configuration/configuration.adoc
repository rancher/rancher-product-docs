...
:page-community-path: integrations-in-rancher/istio/configuration-options/index.adoc 
:page-product-path: observability/istio/configuration/configuration.adoc

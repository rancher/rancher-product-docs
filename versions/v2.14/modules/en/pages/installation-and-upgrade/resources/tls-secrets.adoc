...
:page-community-path: getting-started/installation-and-upgrade/resources/add-tls-secrets.adoc 
:page-product-path: installation-and-upgrade/resources/tls-secrets.adoc

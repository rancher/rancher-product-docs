...
:page-community-path: getting-started/installation-and-upgrade/resources/update-rancher-certificate.adoc 
:page-product-path: installation-and-upgrade/resources/update-rancher-certificate.adoc

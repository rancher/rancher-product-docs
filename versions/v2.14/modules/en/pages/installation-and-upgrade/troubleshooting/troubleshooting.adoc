...
:page-community-path: getting-started/installation-and-upgrade/install-upgrade-on-a-kubernetes-cluster/troubleshooting.adoc 
:page-product-path: installation-and-upgrade/troubleshooting/troubleshooting.adoc

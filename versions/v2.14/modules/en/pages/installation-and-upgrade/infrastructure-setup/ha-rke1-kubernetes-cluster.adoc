...
:page-community-path: how-to-guides/new-user-guides/infrastructure-setup/ha-rke1-kubernetes-cluster.adoc 
:page-product-path: installation-and-upgrade/infrastructure-setup/ha-rke1-kubernetes-cluster.adoc

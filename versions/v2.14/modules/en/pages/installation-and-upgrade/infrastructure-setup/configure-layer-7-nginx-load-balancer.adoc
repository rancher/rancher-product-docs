...
ifeval::["{build-type}" == "community"]
:xref-privileged-access: xref:getting-started/installation-and-upgrade/other-installation-methods/rancher-on-a-single-node-with-docker/index.adoc#_privileged_access_for_rancher
...
ifeval::["{build-type}" == "community"]
This operation requires {xref-privileged-access}[privileged access].
endifeval::[]
ifeval::["{build-type}" != "community"]
This operation requires privileged access.
endifeval::[]

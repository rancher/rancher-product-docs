...
:page-community-path: how-to-guides/new-user-guides/kubernetes-cluster-setup/k3s-for-rancher.adoc 
:page-product-path: installation-and-upgrade/install-kubernetes/k3s-for-rancher.adoc

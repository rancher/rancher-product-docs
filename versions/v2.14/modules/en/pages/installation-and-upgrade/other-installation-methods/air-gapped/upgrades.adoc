...
:page-community-path: getting-started/installation-and-upgrade/install-upgrade-on-a-kubernetes-cluster/air-gapped-upgrades.adoc 
:page-product-path: installation-and-upgrade/other-installation-methods/air-gapped/upgrades.adoc

...
:page-community-path: getting-started/installation-and-upgrade/install-upgrade-on-a-kubernetes-cluster/rancher-on-amazon-eks.adoc 
:page-product-path: installation-and-upgrade/hosted-kubernetes/rancher-on-amazon-eks.adoc
...
This page covers installing Rancher on an Amazon EKS cluster. You can also use https://documentation.suse.com/en-us/cloudnative/rancher-srfa/[SUSE Rancher for AWS] as a distinct, fully managed Software-as-a-Service (SaaS) offering through the AWS Marketplace.

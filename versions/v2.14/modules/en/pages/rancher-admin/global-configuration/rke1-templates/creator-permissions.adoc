...
:page-community-path: how-to-guides/new-user-guides/authentication-permissions-and-global-configuration/about-rke1-templates/creator-permissions.adoc 
:page-product-path: rancher-admin/global-configuration/rke1-templates/creator-permissions.adoc
...
For more information on administrator permissions, refer to the {xref-global-permissions}[documentation on global permissions].
...
For information on allowing users to modify existing templates, refer to {xref-access-share-rke1-templates}[Sharing Templates.]

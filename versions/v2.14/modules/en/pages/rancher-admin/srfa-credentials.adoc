...
For detailed instructions on using this method, refer to xref:cluster-deployment/srfa-quick-start.adoc#_step_2_link_aws_account[Step 2: Link AWS Account] in the Quick Start guide.

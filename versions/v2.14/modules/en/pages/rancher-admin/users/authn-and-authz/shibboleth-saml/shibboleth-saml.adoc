...
:page-community-path: how-to-guides/new-user-guides/authentication-permissions-and-global-configuration/configure-shibboleth-saml/index.adoc 
:page-product-path: rancher-admin/users/authn-and-authz/shibboleth-saml/shibboleth-saml.adoc

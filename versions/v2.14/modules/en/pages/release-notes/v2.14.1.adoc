...
SUSE Rancher now supports Kubernetes v1.35. You can view the https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG/CHANGELOG-1.35.md[upstream Kubernetes changelog] for v1.35 for a complete list of changes. Additionally note that Rancher v2.14 removes support for Kubernetes v1.32.

...
* Fixed an issue with the Google OAuth authentication provider where when upgrading to Rancher v2.14.0 authentication would break preventing users from logging in. See https://github.com/rancher/rancher/issues/54387[#54387].

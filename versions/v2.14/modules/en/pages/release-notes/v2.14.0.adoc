...
[IMPORTANT]
====
If you are using Google OAuth as an authentication provider, upgrading to Rancher v2.14.0 may break authentication, preventing users from logging in.
This issue will be fixed in the upcoming Rancher v2.14.1 release.
See https://github.com/rancher/rancher/issues/54387 for more details.
====

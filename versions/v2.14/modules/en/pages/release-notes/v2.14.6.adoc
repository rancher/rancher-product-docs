...
* Fixed an issue where the Rancher UI offered GKE Kubernetes versions that were not available in any GKE release channel. Rancher v2.14.6 now filters the version list so users cannot select GKE versions that fail to provision because Google requires new GKE clusters to use a release channel. See https://github.com/rancher/dashboard/issues/18929[#18929], https://github.com/rancher/dashboard/issues/18927[#18927], and https://github.com/rancher/rancher/issues/56879[#56879].
...
* *Rancher v2.14.6:*
** Google Cloud deprecated the "No channel" option for new GKE clusters on August 21, 2026. Rancher v2.14.6 filters the GKE Kubernetes version list in the UI so unsupported "No channel"-only versions are no longer offered, but Rancher still does not support selecting a GKE release channel. Until the remaining backend support lands, GCP out-of-band upgrades can still cause state drift that blocks cluster edits, breaks node pool updates, or causes provisioning failures. See https://github.com/rancher/rancher/issues/56879[#56879], https://github.com/rancher/dashboard/issues/18929[#18929], and https://github.com/rancher/dashboard/issues/18916[#18916].
* *Rancher v2.8.1:*

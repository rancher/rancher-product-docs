...
* Google Cloud requires https://docs.cloud.google.com/kubernetes-engine/docs/concepts/release-channels#channels[release channel enrollment] for GKE clusters as of August 21, 2026. Because GCP automatically upgrades clusters out-of-band, Rancher's internal state can drift, leading to provisioning failures, broken node pool updates, and blocked cluster edits. See https://github.com/rancher/rancher/issues/56879[#56879].

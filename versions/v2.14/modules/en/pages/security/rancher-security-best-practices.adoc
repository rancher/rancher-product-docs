...
:page-community-path: reference-guides/rancher-security/rancher-security-best-practices.adoc 
:page-product-path: security/rancher-security-best-practices.adoc

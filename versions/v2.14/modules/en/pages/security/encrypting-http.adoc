...
:page-community-path: how-to-guides/new-user-guides/kubernetes-resources-setup/encrypt-http-communication.adoc 
:page-product-path: security/encrypting-http.adoc

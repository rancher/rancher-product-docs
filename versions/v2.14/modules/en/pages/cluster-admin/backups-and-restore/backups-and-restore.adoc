...
. Configure the options for how pods are deleted. For more information about each option, refer to {xref-nodes-nodepools}#_aggressive_and_safe_draining_options[this section.]

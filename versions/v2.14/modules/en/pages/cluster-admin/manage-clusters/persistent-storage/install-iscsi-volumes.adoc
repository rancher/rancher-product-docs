...
:page-community-path: how-to-guides/new-user-guides/manage-clusters/create-kubernetes-persistent-storage/manage-persistent-storage/install-iscsi-volumes.adoc 
:page-product-path: cluster-admin/manage-clusters/persistent-storage/install-iscsi-volumes.adoc

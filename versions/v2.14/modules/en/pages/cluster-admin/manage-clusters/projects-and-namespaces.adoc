...
:page-community-path: how-to-guides/new-user-guides/manage-clusters/projects-and-namespaces.adoc 
:page-product-path: cluster-admin/manage-clusters/projects-and-namespaces.adoc

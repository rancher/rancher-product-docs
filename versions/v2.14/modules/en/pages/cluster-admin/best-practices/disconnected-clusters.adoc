...
:page-community-path: reference-guides/best-practices/rancher-managed-clusters/disconnected-clusters.adoc 
:page-product-path: cluster-admin/best-practices/disconnected-clusters.adoc

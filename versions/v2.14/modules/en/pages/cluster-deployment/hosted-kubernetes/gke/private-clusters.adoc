...
:page-community-path: reference-guides/cluster-configuration/rancher-server-configuration/gke-cluster-configuration/gke-private-clusters.adoc 
:page-product-path: cluster-deployment/hosted-kubernetes/gke/private-clusters.adoc

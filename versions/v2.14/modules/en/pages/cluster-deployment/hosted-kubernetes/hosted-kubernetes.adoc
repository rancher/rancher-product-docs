...
:page-community-path: how-to-guides/new-user-guides/kubernetes-clusters-in-rancher-setup/set-up-clusters-from-hosted-kubernetes-providers/index.adoc 
:page-product-path: cluster-deployment/hosted-kubernetes/hosted-kubernetes.adoc

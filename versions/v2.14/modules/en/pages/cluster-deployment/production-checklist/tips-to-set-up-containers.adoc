...
:page-community-path: reference-guides/best-practices/rancher-managed-clusters/tips-to-set-up-containers.adoc 
:page-product-path: cluster-deployment/production-checklist/tips-to-set-up-containers.adoc

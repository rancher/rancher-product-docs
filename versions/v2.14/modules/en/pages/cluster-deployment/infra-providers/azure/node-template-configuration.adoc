...
:page-community-path: reference-guides/cluster-configuration/downstream-cluster-configuration/node-template-configuration/azure.adoc 
:page-product-path: cluster-deployment/infra-providers/azure/node-template-configuration.adoc

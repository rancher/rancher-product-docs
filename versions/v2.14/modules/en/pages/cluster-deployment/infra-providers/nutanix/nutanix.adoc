...
* {xref-nutanix-aos-provisioning}#_creating_a_nutanix_aos_cluster[Creating a Nutanix Cluster]
* {xref-nutanix-aos-provisioning}[Provisioning Storage]

[#_creating_a_nutanix_cluster]
== Creating a Nutanix Cluster

In {xref-nutanix-aos-provisioning}[this section,] you'll learn how to use Rancher to install an {url-rke2-landing-page}[RKE2] Kubernetes cluster in Nutanix AOS.

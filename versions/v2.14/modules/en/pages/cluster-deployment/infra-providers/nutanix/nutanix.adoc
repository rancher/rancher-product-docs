...
:page-community-path: how-to-guides/new-user-guides/launch-kubernetes-with-rancher/use-new-nodes-in-an-infra-provider/nutanix/index.adoc 
:page-product-path: cluster-deployment/infra-providers/nutanix/nutanix.adoc

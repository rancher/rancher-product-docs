...
In {xref-nutanix-aos-provisioning}[this section,] you'll learn how to use Rancher to install an https://documentation.suse.com/cloudnative/rke2/[RKE2] Kubernetes cluster in Nutanix AOS.

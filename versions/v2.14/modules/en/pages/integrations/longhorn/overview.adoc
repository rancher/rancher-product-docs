...
ifeval::["{build-type}" == "community"]
:url-storage-overview: https://longhorn.io/docs/what-is-longhorn/
:url-storage-concepts: https://longhorn.io/docs/concepts/
:url-storage-requirements: https://longhorn.io/docs/deploy/install/
:url-storage-settings: https://longhorn.io/docs/references/settings/
endif::[]

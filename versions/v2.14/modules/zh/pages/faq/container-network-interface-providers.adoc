...
如需了解如何为你的集群配置网络插件，请参阅xref:cluster-deployment/configuration/rke2.adoc[集群选项]。有关更高级的配置选项，请参阅有关使用xref:cluster-deployment/configuration/rke2.adoc#_集群配置文件参考[配置文件].

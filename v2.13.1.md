...
> [!IMPORTANT]
> In Rancher Prime v2.13.1, the Helm chart name was changed from `rancher` to `rancher-prime`. When upgrading Rancher instances to Rancher Prime v2.13.1 you may see failures with clusters utilizing the ingress-nginx ingress controller. Please refer to this [knowledge base article](https://support.scc.suse.com/s/kb/Upgrade-to-Rancher-Prime-v2-13-1-fails-in-clusters-with-ingress-nginx?language=en_US) to resolve upgrade issues.
>

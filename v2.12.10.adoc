...
:release-version: v2.12.10
:rn-component-version: v2.12
:previous-release-version: v2.12.9
...
* *Rancher v2.12.9:*
** In air-gapped Harvester installations, the `ui-plugin-catalog` container `compressedEndpoint` field can prevent plugin installation. As a workaround, remove `compressedEndpoint` by running `kubectl edit uiplugin harvester -n cattle-ui-plugin-system`. See https://github.com/rancher/rancher/issues/54659[#54659].
* *Rancher v2.7.2:*
